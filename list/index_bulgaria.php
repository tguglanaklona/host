...
<head>
  ...
  <meta name="keywords" content="list of cities in Bulgaria" />
  <meta name="description" content="list of cities in Bulgaria, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Bulgaria text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Bulgaria</strong></div>
  </a>
  <h1>
    List of populous places in Bulgaria
  </h1>
  <h2>
    Text list of all Bulgaria cities and towns
  </h2>
  <p>
    Here is the full list of Bulgaria cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Bulgaria
  </h2>
  <pre>
    <?php
    $file = "list_cities_bulgaria.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Bulgaria : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_bulgaria.txt">list_cities_bulgaria.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Bulgaria cities, text list of Bulgaria towns, text list of Bulgaria places txt, list of cities in Bulgaria, list of cities in Bulgaria, list of cities in the Bulgaria,
      list of big cities in Bulgaria, list of largest cities in Bulgaria, list of biggest cities in Bulgaria, list of towns in Bulgaria, list of capital cities in Bulgaria,
      names of cities in Bulgaria, list of major cities in Bulgaria, list of most populated cities in Bulgaria, Bulgaria states and cities list
      list of most populated cities in Bulgaria, database cities Bulgaria, database cities Bulgaria, database cities Bulgaria, cities of the Bulgaria
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
