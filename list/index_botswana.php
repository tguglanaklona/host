...
<head>
  ...
  <meta name="keywords" content="list of cities in Botswana" />
  <meta name="description" content="list of cities in Botswana, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Botswana text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Botswana</strong></div>
  </a>
  <h1>
    List of populous places in Botswana
  </h1>
  <h2>
    Text list of all Botswana cities and towns
  </h2>
  <p>
    Here is the full list of Botswana cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Botswana
  </h2>
  <pre>
    <?php
    $file = "list_cities_botswana.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Botswana : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_botswana.txt">list_cities_botswana.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Botswana cities, text list of Botswana towns, text list of Botswana places txt, list of cities in Botswana, list of cities in Botswana, list of cities in the Botswana,
      list of big cities in Botswana, list of largest cities in Botswana, list of biggest cities in Botswana, list of towns in Botswana, list of capital cities in Botswana,
      names of cities in Botswana, list of major cities in Botswana, list of most populated cities in Botswana, Botswana states and cities list
      list of most populated cities in Botswana, database cities Botswana, database cities Botswana, database cities Botswana, cities of the Botswana
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
