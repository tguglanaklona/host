...
<head>
  ...
  <meta name="keywords" content="list of cities in Sri Lanka" />
  <meta name="description" content="list of cities in Sri Lanka, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Sri Lanka text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Sri Lanka</strong></div>
  </a>
  <h1>
    List of populous places in Sri Lanka
  </h1>
  <h2>
    Text list of all Sri Lanka cities and towns
  </h2>
  <p>
    Here is the full list of Sri Lanka cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Sri Lanka
  </h2>
  <pre>
    <?php
    $file = "list_cities_srilanka.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Sri Lanka : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_srilanka.txt">list_cities_srilanka.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Sri Lanka cities, text list of Sri Lanka towns, text list of Sri Lanka places txt, list of cities in Sri Lanka, list of cities in Sri Lanka, list of cities in the Sri Lanka,
      list of big cities in Sri Lanka, list of largest cities in Sri Lanka, list of biggest cities in Sri Lanka, list of towns in Sri Lanka, list of capital cities in Sri Lanka,
      names of cities in Sri Lanka, list of major cities in Sri Lanka, list of most populated cities in Sri Lanka, Sri Lanka states and cities list
      list of most populated cities in Sri Lanka, database cities Sri Lanka, database cities Sri Lanka, database cities Sri Lanka, cities of the Sri Lanka
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
