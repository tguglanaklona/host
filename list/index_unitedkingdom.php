...
<head>
  ...
  <meta name="keywords" content="list of cities in United Kingdom" />
  <meta name="description" content="list of cities in United Kingdom, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="United Kingdom text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>United Kingdom</strong></div>
  </a>
  <h1>
    List of populous places in United Kingdom
  </h1>
  <h2>
    Text list of all United Kingdom cities and towns
  </h2>
  <p>
    Here is the full list of United Kingdom cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in United Kingdom
  </h2>
  <pre>
    <?php
    $file = "list_cities_unitedkingdom.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    United Kingdom : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_unitedkingdom.txt">list_cities_unitedkingdom.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of United Kingdom cities, text list of United Kingdom towns, text list of United Kingdom places txt, list of cities in United Kingdom, list of cities in United Kingdom, list of cities in the United Kingdom,
      list of big cities in United Kingdom, list of largest cities in United Kingdom, list of biggest cities in United Kingdom, list of towns in United Kingdom, list of capital cities in United Kingdom,
      names of cities in United Kingdom, list of major cities in United Kingdom, list of most populated cities in United Kingdom, United Kingdom states and cities list
      list of most populated cities in United Kingdom, database cities United Kingdom, database cities United Kingdom, database cities United Kingdom, cities of the United Kingdom
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
