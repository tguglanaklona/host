...
<head>
  ...
  <meta name="keywords" content="list of cities in Thailand" />
  <meta name="description" content="list of cities in Thailand, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Thailand text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Thailand</strong></div>
  </a>
  <h1>
    List of populous places in Thailand
  </h1>
  <h2>
    Text list of all Thailand cities and towns
  </h2>
  <p>
    Here is the full list of Thailand cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Thailand
  </h2>
  <pre>
    <?php
    $file = "list_cities_thailand.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Thailand : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_thailand.txt">list_cities_thailand.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Thailand cities, text list of Thailand towns, text list of Thailand places txt, list of cities in Thailand, list of cities in Thailand, list of cities in the Thailand,
      list of big cities in Thailand, list of largest cities in Thailand, list of biggest cities in Thailand, list of towns in Thailand, list of capital cities in Thailand,
      names of cities in Thailand, list of major cities in Thailand, list of most populated cities in Thailand, Thailand states and cities list
      list of most populated cities in Thailand, database cities Thailand, database cities Thailand, database cities Thailand, cities of the Thailand
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
