...
<head>
  ...
  <meta name="keywords" content="list of cities in Nepal" />
  <meta name="description" content="list of cities in Nepal, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Nepal text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Nepal</strong></div>
  </a>
  <h1>
    List of populous places in Nepal
  </h1>
  <h2>
    Text list of all Nepal cities and towns
  </h2>
  <p>
    Here is the full list of Nepal cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Nepal
  </h2>
  <pre>
    <?php
    $file = "list_cities_nepal.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Nepal : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_nepal.txt">list_cities_nepal.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Nepal cities, text list of Nepal towns, text list of Nepal places txt, list of cities in Nepal, list of cities in Nepal, list of cities in the Nepal,
      list of big cities in Nepal, list of largest cities in Nepal, list of biggest cities in Nepal, list of towns in Nepal, list of capital cities in Nepal,
      names of cities in Nepal, list of major cities in Nepal, list of most populated cities in Nepal, Nepal states and cities list
      list of most populated cities in Nepal, database cities Nepal, database cities Nepal, database cities Nepal, cities of the Nepal
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
