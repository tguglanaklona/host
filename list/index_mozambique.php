...
<head>
  ...
  <meta name="keywords" content="list of cities in Mozambique" />
  <meta name="description" content="list of cities in Mozambique, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Mozambique text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Mozambique</strong></div>
  </a>
  <h1>
    List of populous places in Mozambique
  </h1>
  <h2>
    Text list of all Mozambique cities and towns
  </h2>
  <p>
    Here is the full list of Mozambique cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Mozambique
  </h2>
  <pre>
    <?php
    $file = "list_cities_mozambique.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Mozambique : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_mozambique.txt">list_cities_mozambique.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Mozambique cities, text list of Mozambique towns, text list of Mozambique places txt, list of cities in Mozambique, list of cities in Mozambique, list of cities in the Mozambique,
      list of big cities in Mozambique, list of largest cities in Mozambique, list of biggest cities in Mozambique, list of towns in Mozambique, list of capital cities in Mozambique,
      names of cities in Mozambique, list of major cities in Mozambique, list of most populated cities in Mozambique, Mozambique states and cities list
      list of most populated cities in Mozambique, database cities Mozambique, database cities Mozambique, database cities Mozambique, cities of the Mozambique
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
