...
<head>
  ...
  <meta name="keywords" content="list of cities in Saudi Arabia" />
  <meta name="description" content="list of cities in Saudi Arabia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Saudi Arabia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Saudi Arabia</strong></div>
  </a>
  <h1>
    List of populous places in Saudi Arabia
  </h1>
  <h2>
    Text list of all Saudi Arabia cities and towns
  </h2>
  <p>
    Here is the full list of Saudi Arabia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Saudi Arabia
  </h2>
  <pre>
    <?php
    $file = "list_cities_saudiarabia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Saudi Arabia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_saudiarabia.txt">list_cities_saudiarabia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Saudi Arabia cities, text list of Saudi Arabia towns, text list of Saudi Arabia places txt, list of cities in Saudi Arabia, list of cities in Saudi Arabia, list of cities in the Saudi Arabia,
      list of big cities in Saudi Arabia, list of largest cities in Saudi Arabia, list of biggest cities in Saudi Arabia, list of towns in Saudi Arabia, list of capital cities in Saudi Arabia,
      names of cities in Saudi Arabia, list of major cities in Saudi Arabia, list of most populated cities in Saudi Arabia, Saudi Arabia states and cities list
      list of most populated cities in Saudi Arabia, database cities Saudi Arabia, database cities Saudi Arabia, database cities Saudi Arabia, cities of the Saudi Arabia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
