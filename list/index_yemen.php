...
<head>
  ...
  <meta name="keywords" content="list of cities in Yemen" />
  <meta name="description" content="list of cities in Yemen, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Yemen text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Yemen</strong></div>
  </a>
  <h1>
    List of populous places in Yemen
  </h1>
  <h2>
    Text list of all Yemen cities and towns
  </h2>
  <p>
    Here is the full list of Yemen cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Yemen
  </h2>
  <pre>
    <?php
    $file = "list_cities_yemen.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Yemen : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_yemen.txt">list_cities_yemen.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Yemen cities, text list of Yemen towns, text list of Yemen places txt, list of cities in Yemen, list of cities in Yemen, list of cities in the Yemen,
      list of big cities in Yemen, list of largest cities in Yemen, list of biggest cities in Yemen, list of towns in Yemen, list of capital cities in Yemen,
      names of cities in Yemen, list of major cities in Yemen, list of most populated cities in Yemen, Yemen states and cities list
      list of most populated cities in Yemen, database cities Yemen, database cities Yemen, database cities Yemen, cities of the Yemen
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
