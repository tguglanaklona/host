...
<head>
  ...
  <meta name="keywords" content="list of cities in Cuba" />
  <meta name="description" content="list of cities in Cuba, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Cuba text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Cuba</strong></div>
  </a>
  <h1>
    List of populous places in Cuba
  </h1>
  <h2>
    Text list of all Cuba cities and towns
  </h2>
  <p>
    Here is the full list of Cuba cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Cuba
  </h2>
  <pre>
    <?php
    $file = "list_cities_cuba.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Cuba : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_cuba.txt">list_cities_cuba.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Cuba cities, text list of Cuba towns, text list of Cuba places txt, list of cities in Cuba, list of cities in Cuba, list of cities in the Cuba,
      list of big cities in Cuba, list of largest cities in Cuba, list of biggest cities in Cuba, list of towns in Cuba, list of capital cities in Cuba,
      names of cities in Cuba, list of major cities in Cuba, list of most populated cities in Cuba, Cuba states and cities list
      list of most populated cities in Cuba, database cities Cuba, database cities Cuba, database cities Cuba, cities of the Cuba
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
