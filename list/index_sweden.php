...
<head>
  ...
  <meta name="keywords" content="list of cities in Sweden" />
  <meta name="description" content="list of cities in Sweden, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Sweden text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Sweden</strong></div>
  </a>
  <h1>
    List of populous places in Sweden
  </h1>
  <h2>
    Text list of all Sweden cities and towns
  </h2>
  <p>
    Here is the full list of Sweden cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Sweden
  </h2>
  <pre>
    <?php
    $file = "list_cities_sweden.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Sweden : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_sweden.txt">list_cities_sweden.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Sweden cities, text list of Sweden towns, text list of Sweden places txt, list of cities in Sweden, list of cities in Sweden, list of cities in the Sweden,
      list of big cities in Sweden, list of largest cities in Sweden, list of biggest cities in Sweden, list of towns in Sweden, list of capital cities in Sweden,
      names of cities in Sweden, list of major cities in Sweden, list of most populated cities in Sweden, Sweden states and cities list
      list of most populated cities in Sweden, database cities Sweden, database cities Sweden, database cities Sweden, cities of the Sweden
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
