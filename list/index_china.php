...
<head>
  ...
  <meta name="keywords" content="list of cities in China" />
  <meta name="description" content="list of cities in China, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="China text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>China</strong></div>
  </a>
  <h1>
    List of populous places in China
  </h1>
  <h2>
    Text list of all China cities and towns
  </h2>
  <p>
    Here is the full list of China cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in China
  </h2>
  <pre>
    <?php
    $file = "list_cities_china.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    China : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_china.txt">list_cities_china.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of China cities, text list of China towns, text list of China places txt, list of cities in China, list of cities in China, list of cities in the China,
      list of big cities in China, list of largest cities in China, list of biggest cities in China, list of towns in China, list of capital cities in China,
      names of cities in China, list of major cities in China, list of most populated cities in China, China states and cities list
      list of most populated cities in China, database cities China, database cities China, database cities China, cities of the China
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
