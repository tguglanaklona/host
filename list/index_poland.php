...
<head>
  ...
  <meta name="keywords" content="list of cities in Poland" />
  <meta name="description" content="list of cities in Poland, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Poland text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Poland</strong></div>
  </a>
  <h1>
    List of populous places in Poland
  </h1>
  <h2>
    Text list of all Poland cities and towns
  </h2>
  <p>
    Here is the full list of Poland cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Poland
  </h2>
  <pre>
    <?php
    $file = "list_cities_poland.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Poland : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_poland.txt">list_cities_poland.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Poland cities, text list of Poland towns, text list of Poland places txt, list of cities in Poland, list of cities in Poland, list of cities in the Poland,
      list of big cities in Poland, list of largest cities in Poland, list of biggest cities in Poland, list of towns in Poland, list of capital cities in Poland,
      names of cities in Poland, list of major cities in Poland, list of most populated cities in Poland, Poland states and cities list
      list of most populated cities in Poland, database cities Poland, database cities Poland, database cities Poland, cities of the Poland
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
