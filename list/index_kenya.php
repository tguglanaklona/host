...
<head>
  ...
  <meta name="keywords" content="list of cities in Kenya" />
  <meta name="description" content="list of cities in Kenya, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Kenya text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Kenya</strong></div>
  </a>
  <h1>
    List of populous places in Kenya
  </h1>
  <h2>
    Text list of all Kenya cities and towns
  </h2>
  <p>
    Here is the full list of Kenya cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Kenya
  </h2>
  <pre>
    <?php
    $file = "list_cities_kenya.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Kenya : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_kenya.txt">list_cities_kenya.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Kenya cities, text list of Kenya towns, text list of Kenya places txt, list of cities in Kenya, list of cities in Kenya, list of cities in the Kenya,
      list of big cities in Kenya, list of largest cities in Kenya, list of biggest cities in Kenya, list of towns in Kenya, list of capital cities in Kenya,
      names of cities in Kenya, list of major cities in Kenya, list of most populated cities in Kenya, Kenya states and cities list
      list of most populated cities in Kenya, database cities Kenya, database cities Kenya, database cities Kenya, cities of the Kenya
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
