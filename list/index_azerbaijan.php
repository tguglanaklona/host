...
<head>
  ...
  <meta name="keywords" content="list of cities in Azerbaijan" />
  <meta name="description" content="list of cities in Azerbaijan, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Azerbaijan text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Azerbaijan</strong></div>
  </a>
  <h1>
    List of populous places in Azerbaijan
  </h1>
  <h2>
    Text list of all Azerbaijan cities and towns
  </h2>
  <p>
    Here is the full list of Azerbaijan cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Azerbaijan
  </h2>
  <pre>
    <?php
    $file = "list_cities_azerbaijan.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Azerbaijan : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_azerbaijan.txt">list_cities_azerbaijan.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Azerbaijan cities, text list of Azerbaijan towns, text list of Azerbaijan places txt, list of cities in Azerbaijan, list of cities in Azerbaijan, list of cities in the Azerbaijan,
      list of big cities in Azerbaijan, list of largest cities in Azerbaijan, list of biggest cities in Azerbaijan, list of towns in Azerbaijan, list of capital cities in Azerbaijan,
      names of cities in Azerbaijan, list of major cities in Azerbaijan, list of most populated cities in Azerbaijan, Azerbaijan states and cities list
      list of most populated cities in Azerbaijan, database cities Azerbaijan, database cities Azerbaijan, database cities Azerbaijan, cities of the Azerbaijan
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
