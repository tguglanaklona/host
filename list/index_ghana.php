...
<head>
  ...
  <meta name="keywords" content="list of cities in Ghana" />
  <meta name="description" content="list of cities in Ghana, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Ghana text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Ghana</strong></div>
  </a>
  <h1>
    List of populous places in Ghana
  </h1>
  <h2>
    Text list of all Ghana cities and towns
  </h2>
  <p>
    Here is the full list of Ghana cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Ghana
  </h2>
  <pre>
    <?php
    $file = "list_cities_ghana.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Ghana : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_ghana.txt">list_cities_ghana.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Ghana cities, text list of Ghana towns, text list of Ghana places txt, list of cities in Ghana, list of cities in Ghana, list of cities in the Ghana,
      list of big cities in Ghana, list of largest cities in Ghana, list of biggest cities in Ghana, list of towns in Ghana, list of capital cities in Ghana,
      names of cities in Ghana, list of major cities in Ghana, list of most populated cities in Ghana, Ghana states and cities list
      list of most populated cities in Ghana, database cities Ghana, database cities Ghana, database cities Ghana, cities of the Ghana
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
