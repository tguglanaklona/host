...
<head>
  ...
  <meta name="keywords" content="list of cities in Zambia" />
  <meta name="description" content="list of cities in Zambia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Zambia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Zambia</strong></div>
  </a>
  <h1>
    List of populous places in Zambia
  </h1>
  <h2>
    Text list of all Zambia cities and towns
  </h2>
  <p>
    Here is the full list of Zambia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Zambia
  </h2>
  <pre>
    <?php
    $file = "list_cities_zambia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Zambia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_zambia.txt">list_cities_zambia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Zambia cities, text list of Zambia towns, text list of Zambia places txt, list of cities in Zambia, list of cities in Zambia, list of cities in the Zambia,
      list of big cities in Zambia, list of largest cities in Zambia, list of biggest cities in Zambia, list of towns in Zambia, list of capital cities in Zambia,
      names of cities in Zambia, list of major cities in Zambia, list of most populated cities in Zambia, Zambia states and cities list
      list of most populated cities in Zambia, database cities Zambia, database cities Zambia, database cities Zambia, cities of the Zambia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
