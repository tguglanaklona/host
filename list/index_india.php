...
<head>
  ...
  <meta name="keywords" content="list of cities in India" />
  <meta name="description" content="list of cities in India, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="India text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>India</strong></div>
  </a>
  <h1>
    List of populous places in India
  </h1>
  <h2>
    Text list of all India cities and towns
  </h2>
  <p>
    Here is the full list of India cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in India
  </h2>
  <pre>
    <?php
    $file = "list_cities_india.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    India : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_india.txt">list_cities_india.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of India cities, text list of India towns, text list of India places txt, list of cities in India, list of cities in India, list of cities in the India,
      list of big cities in India, list of largest cities in India, list of biggest cities in India, list of towns in India, list of capital cities in India,
      names of cities in India, list of major cities in India, list of most populated cities in India, India states and cities list
      list of most populated cities in India, database cities India, database cities India, database cities India, cities of the India
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
