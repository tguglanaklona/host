...
<head>
  ...
  <meta name="keywords" content="list of cities in Israel" />
  <meta name="description" content="list of cities in Israel, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Israel text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Israel</strong></div>
  </a>
  <h1>
    List of populous places in Israel
  </h1>
  <h2>
    Text list of all Israel cities and towns
  </h2>
  <p>
    Here is the full list of Israel cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Israel
  </h2>
  <pre>
    <?php
    $file = "list_cities_israel.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Israel : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_israel.txt">list_cities_israel.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Israel cities, text list of Israel towns, text list of Israel places txt, list of cities in Israel, list of cities in Israel, list of cities in the Israel,
      list of big cities in Israel, list of largest cities in Israel, list of biggest cities in Israel, list of towns in Israel, list of capital cities in Israel,
      names of cities in Israel, list of major cities in Israel, list of most populated cities in Israel, Israel states and cities list
      list of most populated cities in Israel, database cities Israel, database cities Israel, database cities Israel, cities of the Israel
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
