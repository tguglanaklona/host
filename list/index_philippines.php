...
<head>
  ...
  <meta name="keywords" content="list of cities in Philippines" />
  <meta name="description" content="list of cities in Philippines, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Philippines text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Philippines</strong></div>
  </a>
  <h1>
    List of populous places in Philippines
  </h1>
  <h2>
    Text list of all Philippines cities and towns
  </h2>
  <p>
    Here is the full list of Philippines cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Philippines
  </h2>
  <pre>
    <?php
    $file = "list_cities_philippines.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Philippines : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_philippines.txt">list_cities_philippines.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Philippines cities, text list of Philippines towns, text list of Philippines places txt, list of cities in Philippines, list of cities in Philippines, list of cities in the Philippines,
      list of big cities in Philippines, list of largest cities in Philippines, list of biggest cities in Philippines, list of towns in Philippines, list of capital cities in Philippines,
      names of cities in Philippines, list of major cities in Philippines, list of most populated cities in Philippines, Philippines states and cities list
      list of most populated cities in Philippines, database cities Philippines, database cities Philippines, database cities Philippines, cities of the Philippines
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
