...
<head>
  ...
  <meta name="keywords" content="list of cities in Finland" />
  <meta name="description" content="list of cities in Finland, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Finland text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Finland</strong></div>
  </a>
  <h1>
    List of populous places in Finland
  </h1>
  <h2>
    Text list of all Finland cities and towns
  </h2>
  <p>
    Here is the full list of Finland cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Finland
  </h2>
  <pre>
    <?php
    $file = "list_cities_finland.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Finland : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_finland.txt">list_cities_finland.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Finland cities, text list of Finland towns, text list of Finland places txt, list of cities in Finland, list of cities in Finland, list of cities in the Finland,
      list of big cities in Finland, list of largest cities in Finland, list of biggest cities in Finland, list of towns in Finland, list of capital cities in Finland,
      names of cities in Finland, list of major cities in Finland, list of most populated cities in Finland, Finland states and cities list
      list of most populated cities in Finland, database cities Finland, database cities Finland, database cities Finland, cities of the Finland
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
