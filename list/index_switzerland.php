...
<head>
  ...
  <meta name="keywords" content="list of cities in Switzerland" />
  <meta name="description" content="list of cities in Switzerland, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Switzerland text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Switzerland</strong></div>
  </a>
  <h1>
    List of populous places in Switzerland
  </h1>
  <h2>
    Text list of all Switzerland cities and towns
  </h2>
  <p>
    Here is the full list of Switzerland cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Switzerland
  </h2>
  <pre>
    <?php
    $file = "list_cities_switzerland.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Switzerland : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_switzerland.txt">list_cities_switzerland.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Switzerland cities, text list of Switzerland towns, text list of Switzerland places txt, list of cities in Switzerland, list of cities in Switzerland, list of cities in the Switzerland,
      list of big cities in Switzerland, list of largest cities in Switzerland, list of biggest cities in Switzerland, list of towns in Switzerland, list of capital cities in Switzerland,
      names of cities in Switzerland, list of major cities in Switzerland, list of most populated cities in Switzerland, Switzerland states and cities list
      list of most populated cities in Switzerland, database cities Switzerland, database cities Switzerland, database cities Switzerland, cities of the Switzerland
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
