...
<head>
  ...
  <meta name="keywords" content="list of cities in Mauritania" />
  <meta name="description" content="list of cities in Mauritania, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Mauritania text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Mauritania</strong></div>
  </a>
  <h1>
    List of populous places in Mauritania
  </h1>
  <h2>
    Text list of all Mauritania cities and towns
  </h2>
  <p>
    Here is the full list of Mauritania cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Mauritania
  </h2>
  <pre>
    <?php
    $file = "list_cities_mauritania.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Mauritania : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_mauritania.txt">list_cities_mauritania.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Mauritania cities, text list of Mauritania towns, text list of Mauritania places txt, list of cities in Mauritania, list of cities in Mauritania, list of cities in the Mauritania,
      list of big cities in Mauritania, list of largest cities in Mauritania, list of biggest cities in Mauritania, list of towns in Mauritania, list of capital cities in Mauritania,
      names of cities in Mauritania, list of major cities in Mauritania, list of most populated cities in Mauritania, Mauritania states and cities list
      list of most populated cities in Mauritania, database cities Mauritania, database cities Mauritania, database cities Mauritania, cities of the Mauritania
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
