...
<head>
  ...
  <meta name="keywords" content="list of cities in Uruguay" />
  <meta name="description" content="list of cities in Uruguay, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Uruguay text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Uruguay</strong></div>
  </a>
  <h1>
    List of populous places in Uruguay
  </h1>
  <h2>
    Text list of all Uruguay cities and towns
  </h2>
  <p>
    Here is the full list of Uruguay cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Uruguay
  </h2>
  <pre>
    <?php
    $file = "list_cities_uruguay.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Uruguay : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_uruguay.txt">list_cities_uruguay.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Uruguay cities, text list of Uruguay towns, text list of Uruguay places txt, list of cities in Uruguay, list of cities in Uruguay, list of cities in the Uruguay,
      list of big cities in Uruguay, list of largest cities in Uruguay, list of biggest cities in Uruguay, list of towns in Uruguay, list of capital cities in Uruguay,
      names of cities in Uruguay, list of major cities in Uruguay, list of most populated cities in Uruguay, Uruguay states and cities list
      list of most populated cities in Uruguay, database cities Uruguay, database cities Uruguay, database cities Uruguay, cities of the Uruguay
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
