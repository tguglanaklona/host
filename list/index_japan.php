...
<head>
  ...
  <meta name="keywords" content="list of cities in Japan" />
  <meta name="description" content="list of cities in Japan, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Japan text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Japan</strong></div>
  </a>
  <h1>
    List of populous places in Japan
  </h1>
  <h2>
    Text list of all Japan cities and towns
  </h2>
  <p>
    Here is the full list of Japan cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Japan
  </h2>
  <pre>
    <?php
    $file = "list_cities_japan.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Japan : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_japan.txt">list_cities_japan.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Japan cities, text list of Japan towns, text list of Japan places txt, list of cities in Japan, list of cities in Japan, list of cities in the Japan,
      list of big cities in Japan, list of largest cities in Japan, list of biggest cities in Japan, list of towns in Japan, list of capital cities in Japan,
      names of cities in Japan, list of major cities in Japan, list of most populated cities in Japan, Japan states and cities list
      list of most populated cities in Japan, database cities Japan, database cities Japan, database cities Japan, cities of the Japan
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
