...
<head>
  ...
  <meta name="keywords" content="list of cities in Kazakhstan" />
  <meta name="description" content="list of cities in Kazakhstan, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Kazakhstan text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Kazakhstan</strong></div>
  </a>
  <h1>
    List of populous places in Kazakhstan
  </h1>
  <h2>
    Text list of all Kazakhstan cities and towns
  </h2>
  <p>
    Here is the full list of Kazakhstan cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Kazakhstan
  </h2>
  <pre>
    <?php
    $file = "list_cities_kazakhstan.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Kazakhstan : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_kazakhstan.txt">list_cities_kazakhstan.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Kazakhstan cities, text list of Kazakhstan towns, text list of Kazakhstan places txt, list of cities in Kazakhstan, list of cities in Kazakhstan, list of cities in the Kazakhstan,
      list of big cities in Kazakhstan, list of largest cities in Kazakhstan, list of biggest cities in Kazakhstan, list of towns in Kazakhstan, list of capital cities in Kazakhstan,
      names of cities in Kazakhstan, list of major cities in Kazakhstan, list of most populated cities in Kazakhstan, Kazakhstan states and cities list
      list of most populated cities in Kazakhstan, database cities Kazakhstan, database cities Kazakhstan, database cities Kazakhstan, cities of the Kazakhstan
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
