...
<head>
  ...
  <meta name="keywords" content="list of cities in Estonia" />
  <meta name="description" content="list of cities in Estonia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Estonia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Estonia</strong></div>
  </a>
  <h1>
    List of populous places in Estonia
  </h1>
  <h2>
    Text list of all Estonia cities and towns
  </h2>
  <p>
    Here is the full list of Estonia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Estonia
  </h2>
  <pre>
    <?php
    $file = "list_cities_estonia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Estonia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_estonia.txt">list_cities_estonia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Estonia cities, text list of Estonia towns, text list of Estonia places txt, list of cities in Estonia, list of cities in Estonia, list of cities in the Estonia,
      list of big cities in Estonia, list of largest cities in Estonia, list of biggest cities in Estonia, list of towns in Estonia, list of capital cities in Estonia,
      names of cities in Estonia, list of major cities in Estonia, list of most populated cities in Estonia, Estonia states and cities list
      list of most populated cities in Estonia, database cities Estonia, database cities Estonia, database cities Estonia, cities of the Estonia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
