...
<head>
  ...
  <meta name="keywords" content="list of cities in Jordan" />
  <meta name="description" content="list of cities in Jordan, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Jordan text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Jordan</strong></div>
  </a>
  <h1>
    List of populous places in Jordan
  </h1>
  <h2>
    Text list of all Jordan cities and towns
  </h2>
  <p>
    Here is the full list of Jordan cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Jordan
  </h2>
  <pre>
    <?php
    $file = "list_cities_jordan.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Jordan : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_jordan.txt">list_cities_jordan.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Jordan cities, text list of Jordan towns, text list of Jordan places txt, list of cities in Jordan, list of cities in Jordan, list of cities in the Jordan,
      list of big cities in Jordan, list of largest cities in Jordan, list of biggest cities in Jordan, list of towns in Jordan, list of capital cities in Jordan,
      names of cities in Jordan, list of major cities in Jordan, list of most populated cities in Jordan, Jordan states and cities list
      list of most populated cities in Jordan, database cities Jordan, database cities Jordan, database cities Jordan, cities of the Jordan
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
