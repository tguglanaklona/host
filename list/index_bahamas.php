...
<head>
  ...
  <meta name="keywords" content="list of cities in Bahamas" />
  <meta name="description" content="list of cities in Bahamas, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Bahamas text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Bahamas</strong></div>
  </a>
  <h1>
    List of populous places in Bahamas
  </h1>
  <h2>
    Text list of all Bahamas cities and towns
  </h2>
  <p>
    Here is the full list of Bahamas cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Bahamas
  </h2>
  <pre>
    <?php
    $file = "list_cities_bahamas.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Bahamas : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_bahamas.txt">list_cities_bahamas.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Bahamas cities, text list of Bahamas towns, text list of Bahamas places txt, list of cities in Bahamas, list of cities in Bahamas, list of cities in the Bahamas,
      list of big cities in Bahamas, list of largest cities in Bahamas, list of biggest cities in Bahamas, list of towns in Bahamas, list of capital cities in Bahamas,
      names of cities in Bahamas, list of major cities in Bahamas, list of most populated cities in Bahamas, Bahamas states and cities list
      list of most populated cities in Bahamas, database cities Bahamas, database cities Bahamas, database cities Bahamas, cities of the Bahamas
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
