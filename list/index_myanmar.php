...
<head>
  ...
  <meta name="keywords" content="list of cities in Myanmar" />
  <meta name="description" content="list of cities in Myanmar, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Myanmar text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Myanmar</strong></div>
  </a>
  <h1>
    List of populous places in Myanmar
  </h1>
  <h2>
    Text list of all Myanmar cities and towns
  </h2>
  <p>
    Here is the full list of Myanmar cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Myanmar
  </h2>
  <pre>
    <?php
    $file = "list_cities_myanmar.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Myanmar : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_myanmar.txt">list_cities_myanmar.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Myanmar cities, text list of Myanmar towns, text list of Myanmar places txt, list of cities in Myanmar, list of cities in Myanmar, list of cities in the Myanmar,
      list of big cities in Myanmar, list of largest cities in Myanmar, list of biggest cities in Myanmar, list of towns in Myanmar, list of capital cities in Myanmar,
      names of cities in Myanmar, list of major cities in Myanmar, list of most populated cities in Myanmar, Myanmar states and cities list
      list of most populated cities in Myanmar, database cities Myanmar, database cities Myanmar, database cities Myanmar, cities of the Myanmar
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
