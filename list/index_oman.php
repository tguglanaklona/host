...
<head>
  ...
  <meta name="keywords" content="list of cities in Oman" />
  <meta name="description" content="list of cities in Oman, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Oman text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Oman</strong></div>
  </a>
  <h1>
    List of populous places in Oman
  </h1>
  <h2>
    Text list of all Oman cities and towns
  </h2>
  <p>
    Here is the full list of Oman cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Oman
  </h2>
  <pre>
    <?php
    $file = "list_cities_oman.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Oman : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_oman.txt">list_cities_oman.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Oman cities, text list of Oman towns, text list of Oman places txt, list of cities in Oman, list of cities in Oman, list of cities in the Oman,
      list of big cities in Oman, list of largest cities in Oman, list of biggest cities in Oman, list of towns in Oman, list of capital cities in Oman,
      names of cities in Oman, list of major cities in Oman, list of most populated cities in Oman, Oman states and cities list
      list of most populated cities in Oman, database cities Oman, database cities Oman, database cities Oman, cities of the Oman
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
