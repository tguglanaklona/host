...
<head>
  ...
  <meta name="keywords" content="list of cities in Brazil" />
  <meta name="description" content="list of cities in Brazil, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Brazil text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Brazil</strong></div>
  </a>
  <h1>
    List of populous places in Brazil
  </h1>
  <h2>
    Text list of all Brazil cities and towns
  </h2>
  <p>
    Here is the full list of Brazil cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Brazil
  </h2>
  <pre>
    <?php
    $file = "list_cities_brazil.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Brazil : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_brazil.txt">list_cities_brazil.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Brazil cities, text list of Brazil towns, text list of Brazil places txt, list of cities in Brazil, list of cities in Brazil, list of cities in the Brazil,
      list of big cities in Brazil, list of largest cities in Brazil, list of biggest cities in Brazil, list of towns in Brazil, list of capital cities in Brazil,
      names of cities in Brazil, list of major cities in Brazil, list of most populated cities in Brazil, Brazil states and cities list
      list of most populated cities in Brazil, database cities Brazil, database cities Brazil, database cities Brazil, cities of the Brazil
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
