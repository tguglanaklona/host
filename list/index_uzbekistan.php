...
<head>
  ...
  <meta name="keywords" content="list of cities in Uzbekistan" />
  <meta name="description" content="list of cities in Uzbekistan, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Uzbekistan text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Uzbekistan</strong></div>
  </a>
  <h1>
    List of populous places in Uzbekistan
  </h1>
  <h2>
    Text list of all Uzbekistan cities and towns
  </h2>
  <p>
    Here is the full list of Uzbekistan cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Uzbekistan
  </h2>
  <pre>
    <?php
    $file = "list_cities_uzbekistan.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Uzbekistan : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_uzbekistan.txt">list_cities_uzbekistan.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Uzbekistan cities, text list of Uzbekistan towns, text list of Uzbekistan places txt, list of cities in Uzbekistan, list of cities in Uzbekistan, list of cities in the Uzbekistan,
      list of big cities in Uzbekistan, list of largest cities in Uzbekistan, list of biggest cities in Uzbekistan, list of towns in Uzbekistan, list of capital cities in Uzbekistan,
      names of cities in Uzbekistan, list of major cities in Uzbekistan, list of most populated cities in Uzbekistan, Uzbekistan states and cities list
      list of most populated cities in Uzbekistan, database cities Uzbekistan, database cities Uzbekistan, database cities Uzbekistan, cities of the Uzbekistan
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
