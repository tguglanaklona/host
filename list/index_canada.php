...
<head>
  ...
  <meta name="keywords" content="list of cities in Canada" />
  <meta name="description" content="list of cities in Canada, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Canada text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Canada</strong></div>
  </a>
  <h1>
    List of populous places in Canada
  </h1>
  <h2>
    Text list of all Canada cities and towns
  </h2>
  <p>
    Here is the full list of Canada cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Canada
  </h2>
  <pre>
    <?php
    $file = "list_cities_canada.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Canada : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_canada.txt">list_cities_canada.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Canada cities, text list of Canada towns, text list of Canada places txt, list of cities in Canada, list of cities in Canada, list of cities in the Canada,
      list of big cities in Canada, list of largest cities in Canada, list of biggest cities in Canada, list of towns in Canada, list of capital cities in Canada,
      names of cities in Canada, list of major cities in Canada, list of most populated cities in Canada, Canada states and cities list
      list of most populated cities in Canada, database cities Canada, database cities Canada, database cities Canada, cities of the Canada
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
