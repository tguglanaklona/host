...
<head>
  ...
  <meta name="keywords" content="list of cities in New Zealand" />
  <meta name="description" content="list of cities in New Zealand, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="New Zealand text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>New Zealand</strong></div>
  </a>
  <h1>
    List of populous places in New Zealand
  </h1>
  <h2>
    Text list of all New Zealand cities and towns
  </h2>
  <p>
    Here is the full list of New Zealand cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in New Zealand
  </h2>
  <pre>
    <?php
    $file = "list_cities_newzealand.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    New Zealand : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_newzealand.txt">list_cities_newzealand.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of New Zealand cities, text list of New Zealand towns, text list of New Zealand places txt, list of cities in New Zealand, list of cities in New Zealand, list of cities in the New Zealand,
      list of big cities in New Zealand, list of largest cities in New Zealand, list of biggest cities in New Zealand, list of towns in New Zealand, list of capital cities in New Zealand,
      names of cities in New Zealand, list of major cities in New Zealand, list of most populated cities in New Zealand, New Zealand states and cities list
      list of most populated cities in New Zealand, database cities New Zealand, database cities New Zealand, database cities New Zealand, cities of the New Zealand
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
