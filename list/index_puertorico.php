...
<head>
  ...
  <meta name="keywords" content="list of cities in Puerto Rico" />
  <meta name="description" content="list of cities in Puerto Rico, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Puerto Rico text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Puerto Rico</strong></div>
  </a>
  <h1>
    List of populous places in Puerto Rico
  </h1>
  <h2>
    Text list of all Puerto Rico cities and towns
  </h2>
  <p>
    Here is the full list of Puerto Rico cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Puerto Rico
  </h2>
  <pre>
    <?php
    $file = "list_cities_puertorico.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Puerto Rico : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_puertorico.txt">list_cities_puertorico.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Puerto Rico cities, text list of Puerto Rico towns, text list of Puerto Rico places txt, list of cities in Puerto Rico, list of cities in Puerto Rico, list of cities in the Puerto Rico,
      list of big cities in Puerto Rico, list of largest cities in Puerto Rico, list of biggest cities in Puerto Rico, list of towns in Puerto Rico, list of capital cities in Puerto Rico,
      names of cities in Puerto Rico, list of major cities in Puerto Rico, list of most populated cities in Puerto Rico, Puerto Rico states and cities list
      list of most populated cities in Puerto Rico, database cities Puerto Rico, database cities Puerto Rico, database cities Puerto Rico, cities of the Puerto Rico
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
