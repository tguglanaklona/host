...
<head>
  ...
  <meta name="keywords" content="list of cities in Turkmenistan" />
  <meta name="description" content="list of cities in Turkmenistan, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Turkmenistan text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Turkmenistan</strong></div>
  </a>
  <h1>
    List of populous places in Turkmenistan
  </h1>
  <h2>
    Text list of all Turkmenistan cities and towns
  </h2>
  <p>
    Here is the full list of Turkmenistan cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Turkmenistan
  </h2>
  <pre>
    <?php
    $file = "list_cities_turkmenistan.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Turkmenistan : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_turkmenistan.txt">list_cities_turkmenistan.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Turkmenistan cities, text list of Turkmenistan towns, text list of Turkmenistan places txt, list of cities in Turkmenistan, list of cities in Turkmenistan, list of cities in the Turkmenistan,
      list of big cities in Turkmenistan, list of largest cities in Turkmenistan, list of biggest cities in Turkmenistan, list of towns in Turkmenistan, list of capital cities in Turkmenistan,
      names of cities in Turkmenistan, list of major cities in Turkmenistan, list of most populated cities in Turkmenistan, Turkmenistan states and cities list
      list of most populated cities in Turkmenistan, database cities Turkmenistan, database cities Turkmenistan, database cities Turkmenistan, cities of the Turkmenistan
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
