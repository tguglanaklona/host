...
<head>
  ...
  <meta name="keywords" content="list of cities in Belarus" />
  <meta name="description" content="list of cities in Belarus, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Belarus text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Belarus</strong></div>
  </a>
  <h1>
    List of populous places in Belarus
  </h1>
  <h2>
    Text list of all Belarus cities and towns
  </h2>
  <p>
    Here is the full list of Belarus cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Belarus
  </h2>
  <pre>
    <?php
    $file = "list_cities_belarus.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Belarus : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_belarus.txt">list_cities_belarus.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Belarus cities, text list of Belarus towns, text list of Belarus places txt, list of cities in Belarus, list of cities in Belarus, list of cities in the Belarus,
      list of big cities in Belarus, list of largest cities in Belarus, list of biggest cities in Belarus, list of towns in Belarus, list of capital cities in Belarus,
      names of cities in Belarus, list of major cities in Belarus, list of most populated cities in Belarus, Belarus states and cities list
      list of most populated cities in Belarus, database cities Belarus, database cities Belarus, database cities Belarus, cities of the Belarus
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
