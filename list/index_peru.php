...
<head>
  ...
  <meta name="keywords" content="list of cities in Peru" />
  <meta name="description" content="list of cities in Peru, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Peru text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Peru</strong></div>
  </a>
  <h1>
    List of populous places in Peru
  </h1>
  <h2>
    Text list of all Peru cities and towns
  </h2>
  <p>
    Here is the full list of Peru cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Peru
  </h2>
  <pre>
    <?php
    $file = "list_cities_peru.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Peru : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_peru.txt">list_cities_peru.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Peru cities, text list of Peru towns, text list of Peru places txt, list of cities in Peru, list of cities in Peru, list of cities in the Peru,
      list of big cities in Peru, list of largest cities in Peru, list of biggest cities in Peru, list of towns in Peru, list of capital cities in Peru,
      names of cities in Peru, list of major cities in Peru, list of most populated cities in Peru, Peru states and cities list
      list of most populated cities in Peru, database cities Peru, database cities Peru, database cities Peru, cities of the Peru
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
