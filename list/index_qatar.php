...
<head>
  ...
  <meta name="keywords" content="list of cities in Qatar" />
  <meta name="description" content="list of cities in Qatar, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Qatar text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Qatar</strong></div>
  </a>
  <h1>
    List of populous places in Qatar
  </h1>
  <h2>
    Text list of all Qatar cities and towns
  </h2>
  <p>
    Here is the full list of Qatar cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Qatar
  </h2>
  <pre>
    <?php
    $file = "list_cities_qatar.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Qatar : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_qatar.txt">list_cities_qatar.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Qatar cities, text list of Qatar towns, text list of Qatar places txt, list of cities in Qatar, list of cities in Qatar, list of cities in the Qatar,
      list of big cities in Qatar, list of largest cities in Qatar, list of biggest cities in Qatar, list of towns in Qatar, list of capital cities in Qatar,
      names of cities in Qatar, list of major cities in Qatar, list of most populated cities in Qatar, Qatar states and cities list
      list of most populated cities in Qatar, database cities Qatar, database cities Qatar, database cities Qatar, cities of the Qatar
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
