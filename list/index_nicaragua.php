...
<head>
  ...
  <meta name="keywords" content="list of cities in Nicaragua" />
  <meta name="description" content="list of cities in Nicaragua, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Nicaragua text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Nicaragua</strong></div>
  </a>
  <h1>
    List of populous places in Nicaragua
  </h1>
  <h2>
    Text list of all Nicaragua cities and towns
  </h2>
  <p>
    Here is the full list of Nicaragua cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Nicaragua
  </h2>
  <pre>
    <?php
    $file = "list_cities_nicaragua.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Nicaragua : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_nicaragua.txt">list_cities_nicaragua.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Nicaragua cities, text list of Nicaragua towns, text list of Nicaragua places txt, list of cities in Nicaragua, list of cities in Nicaragua, list of cities in the Nicaragua,
      list of big cities in Nicaragua, list of largest cities in Nicaragua, list of biggest cities in Nicaragua, list of towns in Nicaragua, list of capital cities in Nicaragua,
      names of cities in Nicaragua, list of major cities in Nicaragua, list of most populated cities in Nicaragua, Nicaragua states and cities list
      list of most populated cities in Nicaragua, database cities Nicaragua, database cities Nicaragua, database cities Nicaragua, cities of the Nicaragua
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
