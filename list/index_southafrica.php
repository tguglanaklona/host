...
<head>
  ...
  <meta name="keywords" content="list of cities in South Africa" />
  <meta name="description" content="list of cities in South Africa, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="South Africa text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>South Africa</strong></div>
  </a>
  <h1>
    List of populous places in South Africa
  </h1>
  <h2>
    Text list of all South Africa cities and towns
  </h2>
  <p>
    Here is the full list of South Africa cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in South Africa
  </h2>
  <pre>
    <?php
    $file = "list_cities_southafrica.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    South Africa : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_southafrica.txt">list_cities_southafrica.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of South Africa cities, text list of South Africa towns, text list of South Africa places txt, list of cities in South Africa, list of cities in South Africa, list of cities in the South Africa,
      list of big cities in South Africa, list of largest cities in South Africa, list of biggest cities in South Africa, list of towns in South Africa, list of capital cities in South Africa,
      names of cities in South Africa, list of major cities in South Africa, list of most populated cities in South Africa, South Africa states and cities list
      list of most populated cities in South Africa, database cities South Africa, database cities South Africa, database cities South Africa, cities of the South Africa
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
