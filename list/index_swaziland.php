...
<head>
  ...
  <meta name="keywords" content="list of cities in Swaziland" />
  <meta name="description" content="list of cities in Swaziland, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Swaziland text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Swaziland</strong></div>
  </a>
  <h1>
    List of populous places in Swaziland
  </h1>
  <h2>
    Text list of all Swaziland cities and towns
  </h2>
  <p>
    Here is the full list of Swaziland cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Swaziland
  </h2>
  <pre>
    <?php
    $file = "list_cities_swaziland.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Swaziland : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_swaziland.txt">list_cities_swaziland.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Swaziland cities, text list of Swaziland towns, text list of Swaziland places txt, list of cities in Swaziland, list of cities in Swaziland, list of cities in the Swaziland,
      list of big cities in Swaziland, list of largest cities in Swaziland, list of biggest cities in Swaziland, list of towns in Swaziland, list of capital cities in Swaziland,
      names of cities in Swaziland, list of major cities in Swaziland, list of most populated cities in Swaziland, Swaziland states and cities list
      list of most populated cities in Swaziland, database cities Swaziland, database cities Swaziland, database cities Swaziland, cities of the Swaziland
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
