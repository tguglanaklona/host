...
<head>
  ...
  <meta name="keywords" content="list of cities in Argentina" />
  <meta name="description" content="list of cities in Argentina, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Argentina text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Argentina</strong></div>
  </a>
  <h1>
    List of populous places in Argentina
  </h1>
  <h2>
    Text list of all Argentina cities and towns
  </h2>
  <p>
    Here is the full list of Argentina cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Argentina
  </h2>
  <pre>
    <?php
    $file = "list_cities_argentina.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Argentina : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_argentina.txt">list_cities_argentina.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Argentina cities, text list of Argentina towns, text list of Argentina places txt, list of cities in Argentina, list of cities in Argentina, list of cities in the Argentina,
      list of big cities in Argentina, list of largest cities in Argentina, list of biggest cities in Argentina, list of towns in Argentina, list of capital cities in Argentina,
      names of cities in Argentina, list of major cities in Argentina, list of most populated cities in Argentina, Argentina states and cities list
      list of most populated cities in Argentina, database cities Argentina, database cities Argentina, database cities Argentina, cities of the Argentina
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
