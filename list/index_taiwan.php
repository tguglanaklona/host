...
<head>
  ...
  <meta name="keywords" content="list of cities in Taiwan" />
  <meta name="description" content="list of cities in Taiwan, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Taiwan text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Taiwan</strong></div>
  </a>
  <h1>
    List of populous places in Taiwan
  </h1>
  <h2>
    Text list of all Taiwan cities and towns
  </h2>
  <p>
    Here is the full list of Taiwan cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Taiwan
  </h2>
  <pre>
    <?php
    $file = "list_cities_taiwan.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Taiwan : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_taiwan.txt">list_cities_taiwan.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Taiwan cities, text list of Taiwan towns, text list of Taiwan places txt, list of cities in Taiwan, list of cities in Taiwan, list of cities in the Taiwan,
      list of big cities in Taiwan, list of largest cities in Taiwan, list of biggest cities in Taiwan, list of towns in Taiwan, list of capital cities in Taiwan,
      names of cities in Taiwan, list of major cities in Taiwan, list of most populated cities in Taiwan, Taiwan states and cities list
      list of most populated cities in Taiwan, database cities Taiwan, database cities Taiwan, database cities Taiwan, cities of the Taiwan
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
