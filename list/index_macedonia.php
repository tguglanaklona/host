...
<head>
  ...
  <meta name="keywords" content="list of cities in Macedonia" />
  <meta name="description" content="list of cities in Macedonia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Macedonia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Macedonia</strong></div>
  </a>
  <h1>
    List of populous places in Macedonia
  </h1>
  <h2>
    Text list of all Macedonia cities and towns
  </h2>
  <p>
    Here is the full list of Macedonia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Macedonia
  </h2>
  <pre>
    <?php
    $file = "list_cities_macedonia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Macedonia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_macedonia.txt">list_cities_macedonia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Macedonia cities, text list of Macedonia towns, text list of Macedonia places txt, list of cities in Macedonia, list of cities in Macedonia, list of cities in the Macedonia,
      list of big cities in Macedonia, list of largest cities in Macedonia, list of biggest cities in Macedonia, list of towns in Macedonia, list of capital cities in Macedonia,
      names of cities in Macedonia, list of major cities in Macedonia, list of most populated cities in Macedonia, Macedonia states and cities list
      list of most populated cities in Macedonia, database cities Macedonia, database cities Macedonia, database cities Macedonia, cities of the Macedonia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
