...
<head>
  ...
  <meta name="keywords" content="list of cities in Indonesia" />
  <meta name="description" content="list of cities in Indonesia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Indonesia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Indonesia</strong></div>
  </a>
  <h1>
    List of populous places in Indonesia
  </h1>
  <h2>
    Text list of all Indonesia cities and towns
  </h2>
  <p>
    Here is the full list of Indonesia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Indonesia
  </h2>
  <pre>
    <?php
    $file = "list_cities_indonesia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Indonesia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_indonesia.txt">list_cities_indonesia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Indonesia cities, text list of Indonesia towns, text list of Indonesia places txt, list of cities in Indonesia, list of cities in Indonesia, list of cities in the Indonesia,
      list of big cities in Indonesia, list of largest cities in Indonesia, list of biggest cities in Indonesia, list of towns in Indonesia, list of capital cities in Indonesia,
      names of cities in Indonesia, list of major cities in Indonesia, list of most populated cities in Indonesia, Indonesia states and cities list
      list of most populated cities in Indonesia, database cities Indonesia, database cities Indonesia, database cities Indonesia, cities of the Indonesia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
