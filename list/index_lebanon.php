...
<head>
  ...
  <meta name="keywords" content="list of cities in Lebanon" />
  <meta name="description" content="list of cities in Lebanon, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Lebanon text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Lebanon</strong></div>
  </a>
  <h1>
    List of populous places in Lebanon
  </h1>
  <h2>
    Text list of all Lebanon cities and towns
  </h2>
  <p>
    Here is the full list of Lebanon cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Lebanon
  </h2>
  <pre>
    <?php
    $file = "list_cities_lebanon.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Lebanon : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_lebanon.txt">list_cities_lebanon.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Lebanon cities, text list of Lebanon towns, text list of Lebanon places txt, list of cities in Lebanon, list of cities in Lebanon, list of cities in the Lebanon,
      list of big cities in Lebanon, list of largest cities in Lebanon, list of biggest cities in Lebanon, list of towns in Lebanon, list of capital cities in Lebanon,
      names of cities in Lebanon, list of major cities in Lebanon, list of most populated cities in Lebanon, Lebanon states and cities list
      list of most populated cities in Lebanon, database cities Lebanon, database cities Lebanon, database cities Lebanon, cities of the Lebanon
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
