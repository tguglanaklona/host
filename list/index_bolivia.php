...
<head>
  ...
  <meta name="keywords" content="list of cities in Bolivia" />
  <meta name="description" content="list of cities in Bolivia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Bolivia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Bolivia</strong></div>
  </a>
  <h1>
    List of populous places in Bolivia
  </h1>
  <h2>
    Text list of all Bolivia cities and towns
  </h2>
  <p>
    Here is the full list of Bolivia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Bolivia
  </h2>
  <pre>
    <?php
    $file = "list_cities_bolivia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Bolivia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_bolivia.txt">list_cities_bolivia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Bolivia cities, text list of Bolivia towns, text list of Bolivia places txt, list of cities in Bolivia, list of cities in Bolivia, list of cities in the Bolivia,
      list of big cities in Bolivia, list of largest cities in Bolivia, list of biggest cities in Bolivia, list of towns in Bolivia, list of capital cities in Bolivia,
      names of cities in Bolivia, list of major cities in Bolivia, list of most populated cities in Bolivia, Bolivia states and cities list
      list of most populated cities in Bolivia, database cities Bolivia, database cities Bolivia, database cities Bolivia, cities of the Bolivia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
