...
<head>
  ...
  <meta name="keywords" content="list of cities in Libya" />
  <meta name="description" content="list of cities in Libya, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Libya text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Libya</strong></div>
  </a>
  <h1>
    List of populous places in Libya
  </h1>
  <h2>
    Text list of all Libya cities and towns
  </h2>
  <p>
    Here is the full list of Libya cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Libya
  </h2>
  <pre>
    <?php
    $file = "list_cities_libya.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Libya : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_libya.txt">list_cities_libya.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Libya cities, text list of Libya towns, text list of Libya places txt, list of cities in Libya, list of cities in Libya, list of cities in the Libya,
      list of big cities in Libya, list of largest cities in Libya, list of biggest cities in Libya, list of towns in Libya, list of capital cities in Libya,
      names of cities in Libya, list of major cities in Libya, list of most populated cities in Libya, Libya states and cities list
      list of most populated cities in Libya, database cities Libya, database cities Libya, database cities Libya, cities of the Libya
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
