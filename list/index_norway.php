...
<head>
  ...
  <meta name="keywords" content="list of cities in Norway" />
  <meta name="description" content="list of cities in Norway, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Norway text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Norway</strong></div>
  </a>
  <h1>
    List of populous places in Norway
  </h1>
  <h2>
    Text list of all Norway cities and towns
  </h2>
  <p>
    Here is the full list of Norway cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Norway
  </h2>
  <pre>
    <?php
    $file = "list_cities_norway.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Norway : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_norway.txt">list_cities_norway.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Norway cities, text list of Norway towns, text list of Norway places txt, list of cities in Norway, list of cities in Norway, list of cities in the Norway,
      list of big cities in Norway, list of largest cities in Norway, list of biggest cities in Norway, list of towns in Norway, list of capital cities in Norway,
      names of cities in Norway, list of major cities in Norway, list of most populated cities in Norway, Norway states and cities list
      list of most populated cities in Norway, database cities Norway, database cities Norway, database cities Norway, cities of the Norway
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
