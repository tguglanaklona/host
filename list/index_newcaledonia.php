...
<head>
  ...
  <meta name="keywords" content="list of cities in New Caledonia" />
  <meta name="description" content="list of cities in New Caledonia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="New Caledonia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>New Caledonia</strong></div>
  </a>
  <h1>
    List of populous places in New Caledonia
  </h1>
  <h2>
    Text list of all New Caledonia cities and towns
  </h2>
  <p>
    Here is the full list of New Caledonia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in New Caledonia
  </h2>
  <pre>
    <?php
    $file = "list_cities_newcaledonia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    New Caledonia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_newcaledonia.txt">list_cities_newcaledonia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of New Caledonia cities, text list of New Caledonia towns, text list of New Caledonia places txt, list of cities in New Caledonia, list of cities in New Caledonia, list of cities in the New Caledonia,
      list of big cities in New Caledonia, list of largest cities in New Caledonia, list of biggest cities in New Caledonia, list of towns in New Caledonia, list of capital cities in New Caledonia,
      names of cities in New Caledonia, list of major cities in New Caledonia, list of most populated cities in New Caledonia, New Caledonia states and cities list
      list of most populated cities in New Caledonia, database cities New Caledonia, database cities New Caledonia, database cities New Caledonia, cities of the New Caledonia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
