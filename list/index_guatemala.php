...
<head>
  ...
  <meta name="keywords" content="list of cities in Guatemala" />
  <meta name="description" content="list of cities in Guatemala, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Guatemala text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Guatemala</strong></div>
  </a>
  <h1>
    List of populous places in Guatemala
  </h1>
  <h2>
    Text list of all Guatemala cities and towns
  </h2>
  <p>
    Here is the full list of Guatemala cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Guatemala
  </h2>
  <pre>
    <?php
    $file = "list_cities_guatemala.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Guatemala : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_guatemala.txt">list_cities_guatemala.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Guatemala cities, text list of Guatemala towns, text list of Guatemala places txt, list of cities in Guatemala, list of cities in Guatemala, list of cities in the Guatemala,
      list of big cities in Guatemala, list of largest cities in Guatemala, list of biggest cities in Guatemala, list of towns in Guatemala, list of capital cities in Guatemala,
      names of cities in Guatemala, list of major cities in Guatemala, list of most populated cities in Guatemala, Guatemala states and cities list
      list of most populated cities in Guatemala, database cities Guatemala, database cities Guatemala, database cities Guatemala, cities of the Guatemala
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
