...
<head>
  ...
  <meta name="keywords" content="list of cities in Slovenia" />
  <meta name="description" content="list of cities in Slovenia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Slovenia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Slovenia</strong></div>
  </a>
  <h1>
    List of populous places in Slovenia
  </h1>
  <h2>
    Text list of all Slovenia cities and towns
  </h2>
  <p>
    Here is the full list of Slovenia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Slovenia
  </h2>
  <pre>
    <?php
    $file = "list_cities_slovenia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Slovenia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_slovenia.txt">list_cities_slovenia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Slovenia cities, text list of Slovenia towns, text list of Slovenia places txt, list of cities in Slovenia, list of cities in Slovenia, list of cities in the Slovenia,
      list of big cities in Slovenia, list of largest cities in Slovenia, list of biggest cities in Slovenia, list of towns in Slovenia, list of capital cities in Slovenia,
      names of cities in Slovenia, list of major cities in Slovenia, list of most populated cities in Slovenia, Slovenia states and cities list
      list of most populated cities in Slovenia, database cities Slovenia, database cities Slovenia, database cities Slovenia, cities of the Slovenia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
