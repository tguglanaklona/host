...
<head>
  ...
  <meta name="keywords" content="list of cities in Luxembourg" />
  <meta name="description" content="list of cities in Luxembourg, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Luxembourg text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Luxembourg</strong></div>
  </a>
  <h1>
    List of populous places in Luxembourg
  </h1>
  <h2>
    Text list of all Luxembourg cities and towns
  </h2>
  <p>
    Here is the full list of Luxembourg cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Luxembourg
  </h2>
  <pre>
    <?php
    $file = "list_cities_luxembourg.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Luxembourg : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_luxembourg.txt">list_cities_luxembourg.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Luxembourg cities, text list of Luxembourg towns, text list of Luxembourg places txt, list of cities in Luxembourg, list of cities in Luxembourg, list of cities in the Luxembourg,
      list of big cities in Luxembourg, list of largest cities in Luxembourg, list of biggest cities in Luxembourg, list of towns in Luxembourg, list of capital cities in Luxembourg,
      names of cities in Luxembourg, list of major cities in Luxembourg, list of most populated cities in Luxembourg, Luxembourg states and cities list
      list of most populated cities in Luxembourg, database cities Luxembourg, database cities Luxembourg, database cities Luxembourg, cities of the Luxembourg
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
