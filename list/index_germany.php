...
<head>
  ...
  <meta name="keywords" content="list of cities in Germany" />
  <meta name="description" content="list of cities in Germany, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Germany text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Germany</strong></div>
  </a>
  <h1>
    List of populous places in Germany
  </h1>
  <h2>
    Text list of all Germany cities and towns
  </h2>
  <p>
    Here is the full list of Germany cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Germany
  </h2>
  <pre>
    <?php
    $file = "list_cities_germany.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Germany : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_germany.txt">list_cities_germany.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Germany cities, text list of Germany towns, text list of Germany places txt, list of cities in Germany, list of cities in Germany, list of cities in the Germany,
      list of big cities in Germany, list of largest cities in Germany, list of biggest cities in Germany, list of towns in Germany, list of capital cities in Germany,
      names of cities in Germany, list of major cities in Germany, list of most populated cities in Germany, Germany states and cities list
      list of most populated cities in Germany, database cities Germany, database cities Germany, database cities Germany, cities of the Germany
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
