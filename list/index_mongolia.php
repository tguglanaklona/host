...
<head>
  ...
  <meta name="keywords" content="list of cities in Mongolia" />
  <meta name="description" content="list of cities in Mongolia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Mongolia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Mongolia</strong></div>
  </a>
  <h1>
    List of populous places in Mongolia
  </h1>
  <h2>
    Text list of all Mongolia cities and towns
  </h2>
  <p>
    Here is the full list of Mongolia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Mongolia
  </h2>
  <pre>
    <?php
    $file = "list_cities_mongolia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Mongolia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_mongolia.txt">list_cities_mongolia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Mongolia cities, text list of Mongolia towns, text list of Mongolia places txt, list of cities in Mongolia, list of cities in Mongolia, list of cities in the Mongolia,
      list of big cities in Mongolia, list of largest cities in Mongolia, list of biggest cities in Mongolia, list of towns in Mongolia, list of capital cities in Mongolia,
      names of cities in Mongolia, list of major cities in Mongolia, list of most populated cities in Mongolia, Mongolia states and cities list
      list of most populated cities in Mongolia, database cities Mongolia, database cities Mongolia, database cities Mongolia, cities of the Mongolia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
