...
<head>
  ...
  <meta name="keywords" content="list of cities in Montenegro" />
  <meta name="description" content="list of cities in Montenegro, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Montenegro text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Montenegro</strong></div>
  </a>
  <h1>
    List of populous places in Montenegro
  </h1>
  <h2>
    Text list of all Montenegro cities and towns
  </h2>
  <p>
    Here is the full list of Montenegro cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Montenegro
  </h2>
  <pre>
    <?php
    $file = "list_cities_montenegro.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Montenegro : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_montenegro.txt">list_cities_montenegro.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Montenegro cities, text list of Montenegro towns, text list of Montenegro places txt, list of cities in Montenegro, list of cities in Montenegro, list of cities in the Montenegro,
      list of big cities in Montenegro, list of largest cities in Montenegro, list of biggest cities in Montenegro, list of towns in Montenegro, list of capital cities in Montenegro,
      names of cities in Montenegro, list of major cities in Montenegro, list of most populated cities in Montenegro, Montenegro states and cities list
      list of most populated cities in Montenegro, database cities Montenegro, database cities Montenegro, database cities Montenegro, cities of the Montenegro
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
