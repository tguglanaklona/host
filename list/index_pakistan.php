...
<head>
  ...
  <meta name="keywords" content="list of cities in Pakistan" />
  <meta name="description" content="list of cities in Pakistan, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Pakistan text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Pakistan</strong></div>
  </a>
  <h1>
    List of populous places in Pakistan
  </h1>
  <h2>
    Text list of all Pakistan cities and towns
  </h2>
  <p>
    Here is the full list of Pakistan cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Pakistan
  </h2>
  <pre>
    <?php
    $file = "list_cities_pakistan.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Pakistan : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_pakistan.txt">list_cities_pakistan.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Pakistan cities, text list of Pakistan towns, text list of Pakistan places txt, list of cities in Pakistan, list of cities in Pakistan, list of cities in the Pakistan,
      list of big cities in Pakistan, list of largest cities in Pakistan, list of biggest cities in Pakistan, list of towns in Pakistan, list of capital cities in Pakistan,
      names of cities in Pakistan, list of major cities in Pakistan, list of most populated cities in Pakistan, Pakistan states and cities list
      list of most populated cities in Pakistan, database cities Pakistan, database cities Pakistan, database cities Pakistan, cities of the Pakistan
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
