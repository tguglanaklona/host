...
<head>
  ...
  <meta name="keywords" content="list of cities in Tajikistan" />
  <meta name="description" content="list of cities in Tajikistan, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Tajikistan text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Tajikistan</strong></div>
  </a>
  <h1>
    List of populous places in Tajikistan
  </h1>
  <h2>
    Text list of all Tajikistan cities and towns
  </h2>
  <p>
    Here is the full list of Tajikistan cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Tajikistan
  </h2>
  <pre>
    <?php
    $file = "list_cities_tajikistan.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Tajikistan : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_tajikistan.txt">list_cities_tajikistan.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Tajikistan cities, text list of Tajikistan towns, text list of Tajikistan places txt, list of cities in Tajikistan, list of cities in Tajikistan, list of cities in the Tajikistan,
      list of big cities in Tajikistan, list of largest cities in Tajikistan, list of biggest cities in Tajikistan, list of towns in Tajikistan, list of capital cities in Tajikistan,
      names of cities in Tajikistan, list of major cities in Tajikistan, list of most populated cities in Tajikistan, Tajikistan states and cities list
      list of most populated cities in Tajikistan, database cities Tajikistan, database cities Tajikistan, database cities Tajikistan, cities of the Tajikistan
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
