...
<head>
  ...
  <meta name="keywords" content="list of cities in Netherlands" />
  <meta name="description" content="list of cities in Netherlands, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Netherlands text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Netherlands</strong></div>
  </a>
  <h1>
    List of populous places in Netherlands
  </h1>
  <h2>
    Text list of all Netherlands cities and towns
  </h2>
  <p>
    Here is the full list of Netherlands cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Netherlands
  </h2>
  <pre>
    <?php
    $file = "list_cities_netherlands.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Netherlands : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_netherlands.txt">list_cities_netherlands.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Netherlands cities, text list of Netherlands towns, text list of Netherlands places txt, list of cities in Netherlands, list of cities in Netherlands, list of cities in the Netherlands,
      list of big cities in Netherlands, list of largest cities in Netherlands, list of biggest cities in Netherlands, list of towns in Netherlands, list of capital cities in Netherlands,
      names of cities in Netherlands, list of major cities in Netherlands, list of most populated cities in Netherlands, Netherlands states and cities list
      list of most populated cities in Netherlands, database cities Netherlands, database cities Netherlands, database cities Netherlands, cities of the Netherlands
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
