...
<head>
  ...
  <meta name="keywords" content="list of cities in Monaco" />
  <meta name="description" content="list of cities in Monaco, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Monaco text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Monaco</strong></div>
  </a>
  <h1>
    List of populous places in Monaco
  </h1>
  <h2>
    Text list of all Monaco cities and towns
  </h2>
  <p>
    Here is the full list of Monaco cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Monaco
  </h2>
  <pre>
    <?php
    $file = "list_cities_monaco.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Monaco : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_monaco.txt">list_cities_monaco.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Monaco cities, text list of Monaco towns, text list of Monaco places txt, list of cities in Monaco, list of cities in Monaco, list of cities in the Monaco,
      list of big cities in Monaco, list of largest cities in Monaco, list of biggest cities in Monaco, list of towns in Monaco, list of capital cities in Monaco,
      names of cities in Monaco, list of major cities in Monaco, list of most populated cities in Monaco, Monaco states and cities list
      list of most populated cities in Monaco, database cities Monaco, database cities Monaco, database cities Monaco, cities of the Monaco
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
