...
<head>
  ...
  <meta name="keywords" content="list of cities in Egypt" />
  <meta name="description" content="list of cities in Egypt, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Egypt text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Egypt</strong></div>
  </a>
  <h1>
    List of populous places in Egypt
  </h1>
  <h2>
    Text list of all Egypt cities and towns
  </h2>
  <p>
    Here is the full list of Egypt cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Egypt
  </h2>
  <pre>
    <?php
    $file = "list_cities_egypt.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Egypt : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_egypt.txt">list_cities_egypt.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Egypt cities, text list of Egypt towns, text list of Egypt places txt, list of cities in Egypt, list of cities in Egypt, list of cities in the Egypt,
      list of big cities in Egypt, list of largest cities in Egypt, list of biggest cities in Egypt, list of towns in Egypt, list of capital cities in Egypt,
      names of cities in Egypt, list of major cities in Egypt, list of most populated cities in Egypt, Egypt states and cities list
      list of most populated cities in Egypt, database cities Egypt, database cities Egypt, database cities Egypt, cities of the Egypt
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
