...
<head>
  ...
  <meta name="keywords" content="list of cities in Greece" />
  <meta name="description" content="list of cities in Greece, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Greece text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Greece</strong></div>
  </a>
  <h1>
    List of populous places in Greece
  </h1>
  <h2>
    Text list of all Greece cities and towns
  </h2>
  <p>
    Here is the full list of Greece cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Greece
  </h2>
  <pre>
    <?php
    $file = "list_cities_greece.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Greece : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_greece.txt">list_cities_greece.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Greece cities, text list of Greece towns, text list of Greece places txt, list of cities in Greece, list of cities in Greece, list of cities in the Greece,
      list of big cities in Greece, list of largest cities in Greece, list of biggest cities in Greece, list of towns in Greece, list of capital cities in Greece,
      names of cities in Greece, list of major cities in Greece, list of most populated cities in Greece, Greece states and cities list
      list of most populated cities in Greece, database cities Greece, database cities Greece, database cities Greece, cities of the Greece
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
