...
<head>
  ...
  <meta name="keywords" content="list of cities in Russia" />
  <meta name="description" content="list of cities in Russia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Russia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Russia</strong></div>
  </a>
  <h1>
    List of populous places in Russia
  </h1>
  <h2>
    Text list of all Russia cities and towns
  </h2>
  <p>
    Here is the full list of Russia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Russia
  </h2>
  <pre>
    <?php
    $file = "list_cities_russia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Russia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_russia.txt">list_cities_russia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Russia cities, text list of Russia towns, text list of Russia places txt, list of cities in Russia, list of cities in Russia, list of cities in the Russia,
      list of big cities in Russia, list of largest cities in Russia, list of biggest cities in Russia, list of towns in Russia, list of capital cities in Russia,
      names of cities in Russia, list of major cities in Russia, list of most populated cities in Russia, Russia states and cities list
      list of most populated cities in Russia, database cities Russia, database cities Russia, database cities Russia, cities of the Russia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
