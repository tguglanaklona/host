...
<head>
  ...
  <meta name="keywords" content="list of cities in Georgia" />
  <meta name="description" content="list of cities in Georgia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Georgia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Georgia</strong></div>
  </a>
  <h1>
    List of populous places in Georgia
  </h1>
  <h2>
    Text list of all Georgia cities and towns
  </h2>
  <p>
    Here is the full list of Georgia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Georgia
  </h2>
  <pre>
    <?php
    $file = "list_cities_georgia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Georgia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_georgia.txt">list_cities_georgia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Georgia cities, text list of Georgia towns, text list of Georgia places txt, list of cities in Georgia, list of cities in Georgia, list of cities in the Georgia,
      list of big cities in Georgia, list of largest cities in Georgia, list of biggest cities in Georgia, list of towns in Georgia, list of capital cities in Georgia,
      names of cities in Georgia, list of major cities in Georgia, list of most populated cities in Georgia, Georgia states and cities list
      list of most populated cities in Georgia, database cities Georgia, database cities Georgia, database cities Georgia, cities of the Georgia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
