...
<head>
  ...
  <meta name="keywords" content="list of cities in Czech Republic" />
  <meta name="description" content="list of cities in Czech Republic, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Czech Republic text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Czech Republic</strong></div>
  </a>
  <h1>
    List of populous places in Czech Republic
  </h1>
  <h2>
    Text list of all Czech Republic cities and towns
  </h2>
  <p>
    Here is the full list of Czech Republic cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Czech Republic
  </h2>
  <pre>
    <?php
    $file = "list_cities_czechrepublic.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Czech Republic : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_czechrepublic.txt">list_cities_czechrepublic.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Czech Republic cities, text list of Czech Republic towns, text list of Czech Republic places txt, list of cities in Czech Republic, list of cities in Czech Republic, list of cities in the Czech Republic,
      list of big cities in Czech Republic, list of largest cities in Czech Republic, list of biggest cities in Czech Republic, list of towns in Czech Republic, list of capital cities in Czech Republic,
      names of cities in Czech Republic, list of major cities in Czech Republic, list of most populated cities in Czech Republic, Czech Republic states and cities list
      list of most populated cities in Czech Republic, database cities Czech Republic, database cities Czech Republic, database cities Czech Republic, cities of the Czech Republic
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
