...
<head>
  ...
  <meta name="keywords" content="list of cities in Vietnam" />
  <meta name="description" content="list of cities in Vietnam, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Vietnam text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Vietnam</strong></div>
  </a>
  <h1>
    List of populous places in Vietnam
  </h1>
  <h2>
    Text list of all Vietnam cities and towns
  </h2>
  <p>
    Here is the full list of Vietnam cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Vietnam
  </h2>
  <pre>
    <?php
    $file = "list_cities_vietnam.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Vietnam : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_vietnam.txt">list_cities_vietnam.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Vietnam cities, text list of Vietnam towns, text list of Vietnam places txt, list of cities in Vietnam, list of cities in Vietnam, list of cities in the Vietnam,
      list of big cities in Vietnam, list of largest cities in Vietnam, list of biggest cities in Vietnam, list of towns in Vietnam, list of capital cities in Vietnam,
      names of cities in Vietnam, list of major cities in Vietnam, list of most populated cities in Vietnam, Vietnam states and cities list
      list of most populated cities in Vietnam, database cities Vietnam, database cities Vietnam, database cities Vietnam, cities of the Vietnam
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
