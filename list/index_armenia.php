...
<head>
  ...
  <meta name="keywords" content="list of cities in Armenia" />
  <meta name="description" content="list of cities in Armenia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Armenia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Armenia</strong></div>
  </a>
  <h1>
    List of populous places in Armenia
  </h1>
  <h2>
    Text list of all Armenia cities and towns
  </h2>
  <p>
    Here is the full list of Armenia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Armenia
  </h2>
  <pre>
    <?php
    $file = "list_cities_armenia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Armenia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_armenia.txt">list_cities_armenia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Armenia cities, text list of Armenia towns, text list of Armenia places txt, list of cities in Armenia, list of cities in Armenia, list of cities in the Armenia,
      list of big cities in Armenia, list of largest cities in Armenia, list of biggest cities in Armenia, list of towns in Armenia, list of capital cities in Armenia,
      names of cities in Armenia, list of major cities in Armenia, list of most populated cities in Armenia, Armenia states and cities list
      list of most populated cities in Armenia, database cities Armenia, database cities Armenia, database cities Armenia, cities of the Armenia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
