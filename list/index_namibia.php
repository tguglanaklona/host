...
<head>
  ...
  <meta name="keywords" content="list of cities in Namibia" />
  <meta name="description" content="list of cities in Namibia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Namibia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Namibia</strong></div>
  </a>
  <h1>
    List of populous places in Namibia
  </h1>
  <h2>
    Text list of all Namibia cities and towns
  </h2>
  <p>
    Here is the full list of Namibia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Namibia
  </h2>
  <pre>
    <?php
    $file = "list_cities_namibia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Namibia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_namibia.txt">list_cities_namibia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Namibia cities, text list of Namibia towns, text list of Namibia places txt, list of cities in Namibia, list of cities in Namibia, list of cities in the Namibia,
      list of big cities in Namibia, list of largest cities in Namibia, list of biggest cities in Namibia, list of towns in Namibia, list of capital cities in Namibia,
      names of cities in Namibia, list of major cities in Namibia, list of most populated cities in Namibia, Namibia states and cities list
      list of most populated cities in Namibia, database cities Namibia, database cities Namibia, database cities Namibia, cities of the Namibia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
