...
<head>
  ...
  <meta name="keywords" content="list of cities in Liechtenstein" />
  <meta name="description" content="list of cities in Liechtenstein, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Liechtenstein text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Liechtenstein</strong></div>
  </a>
  <h1>
    List of populous places in Liechtenstein
  </h1>
  <h2>
    Text list of all Liechtenstein cities and towns
  </h2>
  <p>
    Here is the full list of Liechtenstein cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Liechtenstein
  </h2>
  <pre>
    <?php
    $file = "list_cities_liechtenstein.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Liechtenstein : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_liechtenstein.txt">list_cities_liechtenstein.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Liechtenstein cities, text list of Liechtenstein towns, text list of Liechtenstein places txt, list of cities in Liechtenstein, list of cities in Liechtenstein, list of cities in the Liechtenstein,
      list of big cities in Liechtenstein, list of largest cities in Liechtenstein, list of biggest cities in Liechtenstein, list of towns in Liechtenstein, list of capital cities in Liechtenstein,
      names of cities in Liechtenstein, list of major cities in Liechtenstein, list of most populated cities in Liechtenstein, Liechtenstein states and cities list
      list of most populated cities in Liechtenstein, database cities Liechtenstein, database cities Liechtenstein, database cities Liechtenstein, cities of the Liechtenstein
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
