...
<head>
  ...
  <meta name="keywords" content="list of cities in Bhutan" />
  <meta name="description" content="list of cities in Bhutan, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Bhutan text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Bhutan</strong></div>
  </a>
  <h1>
    List of populous places in Bhutan
  </h1>
  <h2>
    Text list of all Bhutan cities and towns
  </h2>
  <p>
    Here is the full list of Bhutan cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Bhutan
  </h2>
  <pre>
    <?php
    $file = "list_cities_bhutan.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Bhutan : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_bhutan.txt">list_cities_bhutan.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Bhutan cities, text list of Bhutan towns, text list of Bhutan places txt, list of cities in Bhutan, list of cities in Bhutan, list of cities in the Bhutan,
      list of big cities in Bhutan, list of largest cities in Bhutan, list of biggest cities in Bhutan, list of towns in Bhutan, list of capital cities in Bhutan,
      names of cities in Bhutan, list of major cities in Bhutan, list of most populated cities in Bhutan, Bhutan states and cities list
      list of most populated cities in Bhutan, database cities Bhutan, database cities Bhutan, database cities Bhutan, cities of the Bhutan
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
