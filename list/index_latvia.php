...
<head>
  ...
  <meta name="keywords" content="list of cities in Latvia" />
  <meta name="description" content="list of cities in Latvia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Latvia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Latvia</strong></div>
  </a>
  <h1>
    List of populous places in Latvia
  </h1>
  <h2>
    Text list of all Latvia cities and towns
  </h2>
  <p>
    Here is the full list of Latvia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Latvia
  </h2>
  <pre>
    <?php
    $file = "list_cities_latvia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Latvia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_latvia.txt">list_cities_latvia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Latvia cities, text list of Latvia towns, text list of Latvia places txt, list of cities in Latvia, list of cities in Latvia, list of cities in the Latvia,
      list of big cities in Latvia, list of largest cities in Latvia, list of biggest cities in Latvia, list of towns in Latvia, list of capital cities in Latvia,
      names of cities in Latvia, list of major cities in Latvia, list of most populated cities in Latvia, Latvia states and cities list
      list of most populated cities in Latvia, database cities Latvia, database cities Latvia, database cities Latvia, cities of the Latvia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
