...
<head>
  ...
  <meta name="keywords" content="list of cities in Hungary" />
  <meta name="description" content="list of cities in Hungary, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Hungary text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Hungary</strong></div>
  </a>
  <h1>
    List of populous places in Hungary
  </h1>
  <h2>
    Text list of all Hungary cities and towns
  </h2>
  <p>
    Here is the full list of Hungary cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Hungary
  </h2>
  <pre>
    <?php
    $file = "list_cities_hungary.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Hungary : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_hungary.txt">list_cities_hungary.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Hungary cities, text list of Hungary towns, text list of Hungary places txt, list of cities in Hungary, list of cities in Hungary, list of cities in the Hungary,
      list of big cities in Hungary, list of largest cities in Hungary, list of biggest cities in Hungary, list of towns in Hungary, list of capital cities in Hungary,
      names of cities in Hungary, list of major cities in Hungary, list of most populated cities in Hungary, Hungary states and cities list
      list of most populated cities in Hungary, database cities Hungary, database cities Hungary, database cities Hungary, cities of the Hungary
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
