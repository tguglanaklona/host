...
<head>
  ...
  <meta name="keywords" content="list of cities in USA" />
  <meta name="description" content="list of cities in USA, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="USA text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>USA</strong></div>
  </a>
  <h1>
    List of populous places in USA
  </h1>
  <h2>
    Text list of all USA cities and towns
  </h2>
  <p>
    Here is the full list of USA cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in USA
  </h2>
  <pre>
    <?php
    $file = "list_cities_usa.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    USA : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_usa.txt">list_cities_usa.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of USA cities, text list of USA towns, text list of USA places txt, list of cities in USA, list of cities in USA, list of cities in the USA,
      list of big cities in USA, list of largest cities in USA, list of biggest cities in USA, list of towns in USA, list of capital cities in USA,
      names of cities in USA, list of major cities in USA, list of most populated cities in USA, USA states and cities list
      list of most populated cities in USA, database cities USA, database cities USA, database cities USA, cities of the USA
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
