...
<head>
  ...
  <meta name="keywords" content="list of cities in South Korea" />
  <meta name="description" content="list of cities in South Korea, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="South Korea text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>South Korea</strong></div>
  </a>
  <h1>
    List of populous places in South Korea
  </h1>
  <h2>
    Text list of all South Korea cities and towns
  </h2>
  <p>
    Here is the full list of South Korea cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in South Korea
  </h2>
  <pre>
    <?php
    $file = "list_cities_southkorea.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    South Korea : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_southkorea.txt">list_cities_southkorea.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of South Korea cities, text list of South Korea towns, text list of South Korea places txt, list of cities in South Korea, list of cities in South Korea, list of cities in the South Korea,
      list of big cities in South Korea, list of largest cities in South Korea, list of biggest cities in South Korea, list of towns in South Korea, list of capital cities in South Korea,
      names of cities in South Korea, list of major cities in South Korea, list of most populated cities in South Korea, South Korea states and cities list
      list of most populated cities in South Korea, database cities South Korea, database cities South Korea, database cities South Korea, cities of the South Korea
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
