...
<head>
  ...
  <meta name="keywords" content="list of cities in Austria" />
  <meta name="description" content="list of cities in Austria, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Austria text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Austria</strong></div>
  </a>
  <h1>
    List of populous places in Austria
  </h1>
  <h2>
    Text list of all Austria cities and towns
  </h2>
  <p>
    Here is the full list of Austria cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Austria
  </h2>
  <pre>
    <?php
    $file = "list_cities_austria.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Austria : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_austria.txt">list_cities_austria.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Austria cities, text list of Austria towns, text list of Austria places txt, list of cities in Austria, list of cities in Austria, list of cities in the Austria,
      list of big cities in Austria, list of largest cities in Austria, list of biggest cities in Austria, list of towns in Austria, list of capital cities in Austria,
      names of cities in Austria, list of major cities in Austria, list of most populated cities in Austria, Austria states and cities list
      list of most populated cities in Austria, database cities Austria, database cities Austria, database cities Austria, cities of the Austria
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
