...
<head>
  ...
  <meta name="keywords" content="list of cities in Algeria" />
  <meta name="description" content="list of cities in Algeria, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Algeria text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Algeria</strong></div>
  </a>
  <h1>
    List of populous places in Algeria
  </h1>
  <h2>
    Text list of all Algeria cities and towns
  </h2>
  <p>
    Here is the full list of Algeria cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Algeria
  </h2>
  <pre>
    <?php
    $file = "list_cities_algeria.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Algeria : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_algeria.txt">list_cities_algeria.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Algeria cities, text list of Algeria towns, text list of Algeria places txt, list of cities in Algeria, list of cities in Algeria, list of cities in the Algeria,
      list of big cities in Algeria, list of largest cities in Algeria, list of biggest cities in Algeria, list of towns in Algeria, list of capital cities in Algeria,
      names of cities in Algeria, list of major cities in Algeria, list of most populated cities in Algeria, Algeria states and cities list
      list of most populated cities in Algeria, database cities Algeria, database cities Algeria, database cities Algeria, cities of the Algeria
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
