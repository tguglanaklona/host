...
<head>
  ...
  <meta name="keywords" content="list of cities in Togo" />
  <meta name="description" content="list of cities in Togo, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Togo text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Togo</strong></div>
  </a>
  <h1>
    List of populous places in Togo
  </h1>
  <h2>
    Text list of all Togo cities and towns
  </h2>
  <p>
    Here is the full list of Togo cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Togo
  </h2>
  <pre>
    <?php
    $file = "list_cities_togo.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Togo : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_togo.txt">list_cities_togo.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Togo cities, text list of Togo towns, text list of Togo places txt, list of cities in Togo, list of cities in Togo, list of cities in the Togo,
      list of big cities in Togo, list of largest cities in Togo, list of biggest cities in Togo, list of towns in Togo, list of capital cities in Togo,
      names of cities in Togo, list of major cities in Togo, list of most populated cities in Togo, Togo states and cities list
      list of most populated cities in Togo, database cities Togo, database cities Togo, database cities Togo, cities of the Togo
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
