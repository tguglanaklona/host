...
<head>
  ...
  <meta name="keywords" content="list of cities in Nigeria" />
  <meta name="description" content="list of cities in Nigeria, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Nigeria text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Nigeria</strong></div>
  </a>
  <h1>
    List of populous places in Nigeria
  </h1>
  <h2>
    Text list of all Nigeria cities and towns
  </h2>
  <p>
    Here is the full list of Nigeria cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Nigeria
  </h2>
  <pre>
    <?php
    $file = "list_cities_nigeria.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Nigeria : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_nigeria.txt">list_cities_nigeria.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Nigeria cities, text list of Nigeria towns, text list of Nigeria places txt, list of cities in Nigeria, list of cities in Nigeria, list of cities in the Nigeria,
      list of big cities in Nigeria, list of largest cities in Nigeria, list of biggest cities in Nigeria, list of towns in Nigeria, list of capital cities in Nigeria,
      names of cities in Nigeria, list of major cities in Nigeria, list of most populated cities in Nigeria, Nigeria states and cities list
      list of most populated cities in Nigeria, database cities Nigeria, database cities Nigeria, database cities Nigeria, cities of the Nigeria
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
