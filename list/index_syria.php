...
<head>
  ...
  <meta name="keywords" content="list of cities in Syria" />
  <meta name="description" content="list of cities in Syria, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Syria text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Syria</strong></div>
  </a>
  <h1>
    List of populous places in Syria
  </h1>
  <h2>
    Text list of all Syria cities and towns
  </h2>
  <p>
    Here is the full list of Syria cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Syria
  </h2>
  <pre>
    <?php
    $file = "list_cities_syria.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Syria : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_syria.txt">list_cities_syria.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Syria cities, text list of Syria towns, text list of Syria places txt, list of cities in Syria, list of cities in Syria, list of cities in the Syria,
      list of big cities in Syria, list of largest cities in Syria, list of biggest cities in Syria, list of towns in Syria, list of capital cities in Syria,
      names of cities in Syria, list of major cities in Syria, list of most populated cities in Syria, Syria states and cities list
      list of most populated cities in Syria, database cities Syria, database cities Syria, database cities Syria, cities of the Syria
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
