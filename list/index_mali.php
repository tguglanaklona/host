...
<head>
  ...
  <meta name="keywords" content="list of cities in Mali" />
  <meta name="description" content="list of cities in Mali, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Mali text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Mali</strong></div>
  </a>
  <h1>
    List of populous places in Mali
  </h1>
  <h2>
    Text list of all Mali cities and towns
  </h2>
  <p>
    Here is the full list of Mali cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Mali
  </h2>
  <pre>
    <?php
    $file = "list_cities_mali_replace.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Mali : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_mali_replace.txt">list_cities_mali_replace.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Mali cities, text list of Mali towns, text list of Mali places txt, list of cities in Mali, list of cities in Mali, list of cities in the Mali,
      list of big cities in Mali, list of largest cities in Mali, list of biggest cities in Mali, list of towns in Mali, list of capital cities in Mali,
      names of cities in Mali, list of major cities in Mali, list of most populated cities in Mali, Mali states and cities list
      list of most populated cities in Mali, database cities Mali, database cities Mali, database cities Mali, cities of the Mali
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
