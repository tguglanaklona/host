...
<head>
  ...
  <meta name="keywords" content="list of cities in Serbia" />
  <meta name="description" content="list of cities in Serbia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Serbia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Serbia</strong></div>
  </a>
  <h1>
    List of populous places in Serbia
  </h1>
  <h2>
    Text list of all Serbia cities and towns
  </h2>
  <p>
    Here is the full list of Serbia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Serbia
  </h2>
  <pre>
    <?php
    $file = "list_cities_serbia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Serbia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_serbia.txt">list_cities_serbia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Serbia cities, text list of Serbia towns, text list of Serbia places txt, list of cities in Serbia, list of cities in Serbia, list of cities in the Serbia,
      list of big cities in Serbia, list of largest cities in Serbia, list of biggest cities in Serbia, list of towns in Serbia, list of capital cities in Serbia,
      names of cities in Serbia, list of major cities in Serbia, list of most populated cities in Serbia, Serbia states and cities list
      list of most populated cities in Serbia, database cities Serbia, database cities Serbia, database cities Serbia, cities of the Serbia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
