...
<head>
  ...
  <meta name="keywords" content="list of cities in Jamaica" />
  <meta name="description" content="list of cities in Jamaica, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Jamaica text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Jamaica</strong></div>
  </a>
  <h1>
    List of populous places in Jamaica
  </h1>
  <h2>
    Text list of all Jamaica cities and towns
  </h2>
  <p>
    Here is the full list of Jamaica cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Jamaica
  </h2>
  <pre>
    <?php
    $file = "list_cities_jamaica.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Jamaica : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_jamaica.txt">list_cities_jamaica.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Jamaica cities, text list of Jamaica towns, text list of Jamaica places txt, list of cities in Jamaica, list of cities in Jamaica, list of cities in the Jamaica,
      list of big cities in Jamaica, list of largest cities in Jamaica, list of biggest cities in Jamaica, list of towns in Jamaica, list of capital cities in Jamaica,
      names of cities in Jamaica, list of major cities in Jamaica, list of most populated cities in Jamaica, Jamaica states and cities list
      list of most populated cities in Jamaica, database cities Jamaica, database cities Jamaica, database cities Jamaica, cities of the Jamaica
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
