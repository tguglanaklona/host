...
<head>
  ...
  <meta name="keywords" content="list of cities in Chile" />
  <meta name="description" content="list of cities in Chile, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Chile text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Chile</strong></div>
  </a>
  <h1>
    List of populous places in Chile
  </h1>
  <h2>
    Text list of all Chile cities and towns
  </h2>
  <p>
    Here is the full list of Chile cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Chile
  </h2>
  <pre>
    <?php
    $file = "list_cities_chile.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Chile : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_chile.txt">list_cities_chile.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Chile cities, text list of Chile towns, text list of Chile places txt, list of cities in Chile, list of cities in Chile, list of cities in the Chile,
      list of big cities in Chile, list of largest cities in Chile, list of biggest cities in Chile, list of towns in Chile, list of capital cities in Chile,
      names of cities in Chile, list of major cities in Chile, list of most populated cities in Chile, Chile states and cities list
      list of most populated cities in Chile, database cities Chile, database cities Chile, database cities Chile, cities of the Chile
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
