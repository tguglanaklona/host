...
<head>
  ...
  <meta name="keywords" content="list of cities in Guinea Bissau" />
  <meta name="description" content="list of cities in Guinea Bissau, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Guinea Bissau text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Guinea Bissau</strong></div>
  </a>
  <h1>
    List of populous places in Guinea Bissau
  </h1>
  <h2>
    Text list of all Guinea Bissau cities and towns
  </h2>
  <p>
    Here is the full list of Guinea Bissau cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Guinea Bissau
  </h2>
  <pre>
    <?php
    $file = "list_cities_guineabissau.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Guinea Bissau : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_guineabissau.txt">list_cities_guineabissau.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Guinea Bissau cities, text list of Guinea Bissau towns, text list of Guinea Bissau places txt, list of cities in Guinea Bissau, list of cities in Guinea Bissau, list of cities in the Guinea Bissau,
      list of big cities in Guinea Bissau, list of largest cities in Guinea Bissau, list of biggest cities in Guinea Bissau, list of towns in Guinea Bissau, list of capital cities in Guinea Bissau,
      names of cities in Guinea Bissau, list of major cities in Guinea Bissau, list of most populated cities in Guinea Bissau, Guinea Bissau states and cities list
      list of most populated cities in Guinea Bissau, database cities Guinea Bissau, database cities Guinea Bissau, database cities Guinea Bissau, cities of the Guinea Bissau
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
