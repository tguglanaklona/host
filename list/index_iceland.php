...
<head>
  ...
  <meta name="keywords" content="list of cities in Iceland" />
  <meta name="description" content="list of cities in Iceland, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Iceland text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Iceland</strong></div>
  </a>
  <h1>
    List of populous places in Iceland
  </h1>
  <h2>
    Text list of all Iceland cities and towns
  </h2>
  <p>
    Here is the full list of Iceland cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Iceland
  </h2>
  <pre>
    <?php
    $file = "list_cities_iceland.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Iceland : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_iceland.txt">list_cities_iceland.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Iceland cities, text list of Iceland towns, text list of Iceland places txt, list of cities in Iceland, list of cities in Iceland, list of cities in the Iceland,
      list of big cities in Iceland, list of largest cities in Iceland, list of biggest cities in Iceland, list of towns in Iceland, list of capital cities in Iceland,
      names of cities in Iceland, list of major cities in Iceland, list of most populated cities in Iceland, Iceland states and cities list
      list of most populated cities in Iceland, database cities Iceland, database cities Iceland, database cities Iceland, cities of the Iceland
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
