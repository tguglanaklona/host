...
<head>
  ...
  <meta name="keywords" content="list of cities in Ireland" />
  <meta name="description" content="list of cities in Ireland, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Ireland text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Ireland</strong></div>
  </a>
  <h1>
    List of populous places in Ireland
  </h1>
  <h2>
    Text list of all Ireland cities and towns
  </h2>
  <p>
    Here is the full list of Ireland cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Ireland
  </h2>
  <pre>
    <?php
    $file = "list_cities_ireland.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Ireland : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_ireland.txt">list_cities_ireland.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Ireland cities, text list of Ireland towns, text list of Ireland places txt, list of cities in Ireland, list of cities in Ireland, list of cities in the Ireland,
      list of big cities in Ireland, list of largest cities in Ireland, list of biggest cities in Ireland, list of towns in Ireland, list of capital cities in Ireland,
      names of cities in Ireland, list of major cities in Ireland, list of most populated cities in Ireland, Ireland states and cities list
      list of most populated cities in Ireland, database cities Ireland, database cities Ireland, database cities Ireland, cities of the Ireland
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
