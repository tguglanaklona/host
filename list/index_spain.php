...
<head>
  ...
  <meta name="keywords" content="list of cities in Spain" />
  <meta name="description" content="list of cities in Spain, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Spain text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Spain</strong></div>
  </a>
  <h1>
    List of populous places in Spain
  </h1>
  <h2>
    Text list of all Spain cities and towns
  </h2>
  <p>
    Here is the full list of Spain cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Spain
  </h2>
  <pre>
    <?php
    $file = "list_cities_spain.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Spain : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_spain.txt">list_cities_spain.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Spain cities, text list of Spain towns, text list of Spain places txt, list of cities in Spain, list of cities in Spain, list of cities in the Spain,
      list of big cities in Spain, list of largest cities in Spain, list of biggest cities in Spain, list of towns in Spain, list of capital cities in Spain,
      names of cities in Spain, list of major cities in Spain, list of most populated cities in Spain, Spain states and cities list
      list of most populated cities in Spain, database cities Spain, database cities Spain, database cities Spain, cities of the Spain
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
