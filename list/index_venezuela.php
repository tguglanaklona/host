...
<head>
  ...
  <meta name="keywords" content="list of cities in Venezuela" />
  <meta name="description" content="list of cities in Venezuela, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Venezuela text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Venezuela</strong></div>
  </a>
  <h1>
    List of populous places in Venezuela
  </h1>
  <h2>
    Text list of all Venezuela cities and towns
  </h2>
  <p>
    Here is the full list of Venezuela cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Venezuela
  </h2>
  <pre>
    <?php
    $file = "list_cities_venezuela.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Venezuela : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_venezuela.txt">list_cities_venezuela.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Venezuela cities, text list of Venezuela towns, text list of Venezuela places txt, list of cities in Venezuela, list of cities in Venezuela, list of cities in the Venezuela,
      list of big cities in Venezuela, list of largest cities in Venezuela, list of biggest cities in Venezuela, list of towns in Venezuela, list of capital cities in Venezuela,
      names of cities in Venezuela, list of major cities in Venezuela, list of most populated cities in Venezuela, Venezuela states and cities list
      list of most populated cities in Venezuela, database cities Venezuela, database cities Venezuela, database cities Venezuela, cities of the Venezuela
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
