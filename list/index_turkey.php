...
<head>
  ...
  <meta name="keywords" content="list of cities in Turkey" />
  <meta name="description" content="list of cities in Turkey, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Turkey text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Turkey</strong></div>
  </a>
  <h1>
    List of populous places in Turkey
  </h1>
  <h2>
    Text list of all Turkey cities and towns
  </h2>
  <p>
    Here is the full list of Turkey cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Turkey
  </h2>
  <pre>
    <?php
    $file = "list_cities_turkey.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Turkey : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_turkey.txt">list_cities_turkey.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Turkey cities, text list of Turkey towns, text list of Turkey places txt, list of cities in Turkey, list of cities in Turkey, list of cities in the Turkey,
      list of big cities in Turkey, list of largest cities in Turkey, list of biggest cities in Turkey, list of towns in Turkey, list of capital cities in Turkey,
      names of cities in Turkey, list of major cities in Turkey, list of most populated cities in Turkey, Turkey states and cities list
      list of most populated cities in Turkey, database cities Turkey, database cities Turkey, database cities Turkey, cities of the Turkey
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
