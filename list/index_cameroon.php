...
<head>
  ...
  <meta name="keywords" content="list of cities in Cameroon" />
  <meta name="description" content="list of cities in Cameroon, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Cameroon text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Cameroon</strong></div>
  </a>
  <h1>
    List of populous places in Cameroon
  </h1>
  <h2>
    Text list of all Cameroon cities and towns
  </h2>
  <p>
    Here is the full list of Cameroon cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Cameroon
  </h2>
  <pre>
    <?php
    $file = "list_cities_cameroon.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Cameroon : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_cameroon.txt">list_cities_cameroon.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Cameroon cities, text list of Cameroon towns, text list of Cameroon places txt, list of cities in Cameroon, list of cities in Cameroon, list of cities in the Cameroon,
      list of big cities in Cameroon, list of largest cities in Cameroon, list of biggest cities in Cameroon, list of towns in Cameroon, list of capital cities in Cameroon,
      names of cities in Cameroon, list of major cities in Cameroon, list of most populated cities in Cameroon, Cameroon states and cities list
      list of most populated cities in Cameroon, database cities Cameroon, database cities Cameroon, database cities Cameroon, cities of the Cameroon
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
