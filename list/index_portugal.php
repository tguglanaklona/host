...
<head>
  ...
  <meta name="keywords" content="list of cities in Portugal" />
  <meta name="description" content="list of cities in Portugal, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Portugal text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Portugal</strong></div>
  </a>
  <h1>
    List of populous places in Portugal
  </h1>
  <h2>
    Text list of all Portugal cities and towns
  </h2>
  <p>
    Here is the full list of Portugal cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Portugal
  </h2>
  <pre>
    <?php
    $file = "list_cities_portugal.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Portugal : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_portugal.txt">list_cities_portugal.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Portugal cities, text list of Portugal towns, text list of Portugal places txt, list of cities in Portugal, list of cities in Portugal, list of cities in the Portugal,
      list of big cities in Portugal, list of largest cities in Portugal, list of biggest cities in Portugal, list of towns in Portugal, list of capital cities in Portugal,
      names of cities in Portugal, list of major cities in Portugal, list of most populated cities in Portugal, Portugal states and cities list
      list of most populated cities in Portugal, database cities Portugal, database cities Portugal, database cities Portugal, cities of the Portugal
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
