...
<head>
  ...
  <meta name="keywords" content="list of cities in Morocco" />
  <meta name="description" content="list of cities in Morocco, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Morocco text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Morocco</strong></div>
  </a>
  <h1>
    List of populous places in Morocco
  </h1>
  <h2>
    Text list of all Morocco cities and towns
  </h2>
  <p>
    Here is the full list of Morocco cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Morocco
  </h2>
  <pre>
    <?php
    $file = "list_cities_morocco.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Morocco : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_morocco.txt">list_cities_morocco.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Morocco cities, text list of Morocco towns, text list of Morocco places txt, list of cities in Morocco, list of cities in Morocco, list of cities in the Morocco,
      list of big cities in Morocco, list of largest cities in Morocco, list of biggest cities in Morocco, list of towns in Morocco, list of capital cities in Morocco,
      names of cities in Morocco, list of major cities in Morocco, list of most populated cities in Morocco, Morocco states and cities list
      list of most populated cities in Morocco, database cities Morocco, database cities Morocco, database cities Morocco, cities of the Morocco
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
