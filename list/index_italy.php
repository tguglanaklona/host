...
<head>
  ...
  <meta name="keywords" content="list of cities in Italy" />
  <meta name="description" content="list of cities in Italy, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Italy text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Italy</strong></div>
  </a>
  <h1>
    List of populous places in Italy
  </h1>
  <h2>
    Text list of all Italy cities and towns
  </h2>
  <p>
    Here is the full list of Italy cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Italy
  </h2>
  <pre>
    <?php
    $file = "list_cities_italy.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Italy : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_italy.txt">list_cities_italy.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Italy cities, text list of Italy towns, text list of Italy places txt, list of cities in Italy, list of cities in Italy, list of cities in the Italy,
      list of big cities in Italy, list of largest cities in Italy, list of biggest cities in Italy, list of towns in Italy, list of capital cities in Italy,
      names of cities in Italy, list of major cities in Italy, list of most populated cities in Italy, Italy states and cities list
      list of most populated cities in Italy, database cities Italy, database cities Italy, database cities Italy, cities of the Italy
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
