...
<head>
  ...
  <meta name="keywords" content="list of cities in Palestine" />
  <meta name="description" content="list of cities in Palestine, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Palestine text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Palestine</strong></div>
  </a>
  <h1>
    List of populous places in Palestine
  </h1>
  <h2>
    Text list of all Palestine cities and towns
  </h2>
  <p>
    Here is the full list of Palestine cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Palestine
  </h2>
  <pre>
    <?php
    $file = "list_cities_palestine.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Palestine : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_palestine.txt">list_cities_palestine.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Palestine cities, text list of Palestine towns, text list of Palestine places txt, list of cities in Palestine, list of cities in Palestine, list of cities in the Palestine,
      list of big cities in Palestine, list of largest cities in Palestine, list of biggest cities in Palestine, list of towns in Palestine, list of capital cities in Palestine,
      names of cities in Palestine, list of major cities in Palestine, list of most populated cities in Palestine, Palestine states and cities list
      list of most populated cities in Palestine, database cities Palestine, database cities Palestine, database cities Palestine, cities of the Palestine
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
