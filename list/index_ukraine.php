...
<head>
  ...
  <meta name="keywords" content="list of cities in Ukraine" />
  <meta name="description" content="list of cities in Ukraine, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Ukraine text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Ukraine</strong></div>
  </a>
  <h1>
    List of populous places in Ukraine
  </h1>
  <h2>
    Text list of all Ukraine cities and towns
  </h2>
  <p>
    Here is the full list of Ukraine cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Ukraine
  </h2>
  <pre>
    <?php
    $file = "list_cities_ukraine.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Ukraine : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_ukraine.txt">list_cities_ukraine.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Ukraine cities, text list of Ukraine towns, text list of Ukraine places txt, list of cities in Ukraine, list of cities in Ukraine, list of cities in the Ukraine,
      list of big cities in Ukraine, list of largest cities in Ukraine, list of biggest cities in Ukraine, list of towns in Ukraine, list of capital cities in Ukraine,
      names of cities in Ukraine, list of major cities in Ukraine, list of most populated cities in Ukraine, Ukraine states and cities list
      list of most populated cities in Ukraine, database cities Ukraine, database cities Ukraine, database cities Ukraine, cities of the Ukraine
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
