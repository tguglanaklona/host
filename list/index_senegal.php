...
<head>
  ...
  <meta name="keywords" content="list of cities in Senegal" />
  <meta name="description" content="list of cities in Senegal, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Senegal text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Senegal</strong></div>
  </a>
  <h1>
    List of populous places in Senegal
  </h1>
  <h2>
    Text list of all Senegal cities and towns
  </h2>
  <p>
    Here is the full list of Senegal cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Senegal
  </h2>
  <pre>
    <?php
    $file = "list_cities_senegal.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Senegal : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_senegal.txt">list_cities_senegal.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Senegal cities, text list of Senegal towns, text list of Senegal places txt, list of cities in Senegal, list of cities in Senegal, list of cities in the Senegal,
      list of big cities in Senegal, list of largest cities in Senegal, list of biggest cities in Senegal, list of towns in Senegal, list of capital cities in Senegal,
      names of cities in Senegal, list of major cities in Senegal, list of most populated cities in Senegal, Senegal states and cities list
      list of most populated cities in Senegal, database cities Senegal, database cities Senegal, database cities Senegal, cities of the Senegal
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
