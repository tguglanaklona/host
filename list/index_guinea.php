...
<head>
  ...
  <meta name="keywords" content="list of cities in Guinea" />
  <meta name="description" content="list of cities in Guinea, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Guinea text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Guinea</strong></div>
  </a>
  <h1>
    List of populous places in Guinea
  </h1>
  <h2>
    Text list of all Guinea cities and towns
  </h2>
  <p>
    Here is the full list of Guinea cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Guinea
  </h2>
  <pre>
    <?php
    $file = "list_cities_guinea.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Guinea : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_guinea.txt">list_cities_guinea.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Guinea cities, text list of Guinea towns, text list of Guinea places txt, list of cities in Guinea, list of cities in Guinea, list of cities in the Guinea,
      list of big cities in Guinea, list of largest cities in Guinea, list of biggest cities in Guinea, list of towns in Guinea, list of capital cities in Guinea,
      names of cities in Guinea, list of major cities in Guinea, list of most populated cities in Guinea, Guinea states and cities list
      list of most populated cities in Guinea, database cities Guinea, database cities Guinea, database cities Guinea, cities of the Guinea
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
