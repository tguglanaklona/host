...
<head>
  ...
  <meta name="keywords" content="list of cities in Colombia" />
  <meta name="description" content="list of cities in Colombia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Colombia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Colombia</strong></div>
  </a>
  <h1>
    List of populous places in Colombia
  </h1>
  <h2>
    Text list of all Colombia cities and towns
  </h2>
  <p>
    Here is the full list of Colombia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Colombia
  </h2>
  <pre>
    <?php
    $file = "list_cities_colombia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Colombia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_colombia.txt">list_cities_colombia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Colombia cities, text list of Colombia towns, text list of Colombia places txt, list of cities in Colombia, list of cities in Colombia, list of cities in the Colombia,
      list of big cities in Colombia, list of largest cities in Colombia, list of biggest cities in Colombia, list of towns in Colombia, list of capital cities in Colombia,
      names of cities in Colombia, list of major cities in Colombia, list of most populated cities in Colombia, Colombia states and cities list
      list of most populated cities in Colombia, database cities Colombia, database cities Colombia, database cities Colombia, cities of the Colombia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
