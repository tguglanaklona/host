...
<head>
  ...
  <meta name="keywords" content="list of cities in Panama" />
  <meta name="description" content="list of cities in Panama, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Panama text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Panama</strong></div>
  </a>
  <h1>
    List of populous places in Panama
  </h1>
  <h2>
    Text list of all Panama cities and towns
  </h2>
  <p>
    Here is the full list of Panama cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Panama
  </h2>
  <pre>
    <?php
    $file = "list_cities_panama.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Panama : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_panama.txt">list_cities_panama.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Panama cities, text list of Panama towns, text list of Panama places txt, list of cities in Panama, list of cities in Panama, list of cities in the Panama,
      list of big cities in Panama, list of largest cities in Panama, list of biggest cities in Panama, list of towns in Panama, list of capital cities in Panama,
      names of cities in Panama, list of major cities in Panama, list of most populated cities in Panama, Panama states and cities list
      list of most populated cities in Panama, database cities Panama, database cities Panama, database cities Panama, cities of the Panama
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
