...
<head>
  ...
  <meta name="keywords" content="list of cities in Kosovo" />
  <meta name="description" content="list of cities in Kosovo, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Kosovo text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Kosovo</strong></div>
  </a>
  <h1>
    List of populous places in Kosovo
  </h1>
  <h2>
    Text list of all Kosovo cities and towns
  </h2>
  <p>
    Here is the full list of Kosovo cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Kosovo
  </h2>
  <pre>
    <?php
    $file = "list_cities_kosovo.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Kosovo : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_kosovo.txt">list_cities_kosovo.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Kosovo cities, text list of Kosovo towns, text list of Kosovo places txt, list of cities in Kosovo, list of cities in Kosovo, list of cities in the Kosovo,
      list of big cities in Kosovo, list of largest cities in Kosovo, list of biggest cities in Kosovo, list of towns in Kosovo, list of capital cities in Kosovo,
      names of cities in Kosovo, list of major cities in Kosovo, list of most populated cities in Kosovo, Kosovo states and cities list
      list of most populated cities in Kosovo, database cities Kosovo, database cities Kosovo, database cities Kosovo, cities of the Kosovo
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
