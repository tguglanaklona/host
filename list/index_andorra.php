...
<head>
  ...
  <meta name="keywords" content="list of cities in Andorra" />
  <meta name="description" content="list of cities in Andorra, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Andorra text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Andorra</strong></div>
  </a>
  <h1>
    List of populous places in Andorra
  </h1>
  <h2>
    Text list of all Andorra cities and towns
  </h2>
  <p>
    Here is the full list of Andorra cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Andorra
  </h2>
  <pre>
    <?php
    $file = "list_cities_andorra.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Andorra : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_andorra.txt">list_cities_andorra.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Andorra cities, text list of Andorra towns, text list of Andorra places txt, list of cities in Andorra, list of cities in Andorra, list of cities in the Andorra,
      list of big cities in Andorra, list of largest cities in Andorra, list of biggest cities in Andorra, list of towns in Andorra, list of capital cities in Andorra,
      names of cities in Andorra, list of major cities in Andorra, list of most populated cities in Andorra, Andorra states and cities list
      list of most populated cities in Andorra, database cities Andorra, database cities Andorra, database cities Andorra, cities of the Andorra
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
