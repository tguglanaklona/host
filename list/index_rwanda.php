...
<head>
  ...
  <meta name="keywords" content="list of cities in Rwanda" />
  <meta name="description" content="list of cities in Rwanda, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Rwanda text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Rwanda</strong></div>
  </a>
  <h1>
    List of populous places in Rwanda
  </h1>
  <h2>
    Text list of all Rwanda cities and towns
  </h2>
  <p>
    Here is the full list of Rwanda cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Rwanda
  </h2>
  <pre>
    <?php
    $file = "list_cities_rwanda.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Rwanda : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_rwanda.txt">list_cities_rwanda.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Rwanda cities, text list of Rwanda towns, text list of Rwanda places txt, list of cities in Rwanda, list of cities in Rwanda, list of cities in the Rwanda,
      list of big cities in Rwanda, list of largest cities in Rwanda, list of biggest cities in Rwanda, list of towns in Rwanda, list of capital cities in Rwanda,
      names of cities in Rwanda, list of major cities in Rwanda, list of most populated cities in Rwanda, Rwanda states and cities list
      list of most populated cities in Rwanda, database cities Rwanda, database cities Rwanda, database cities Rwanda, cities of the Rwanda
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
