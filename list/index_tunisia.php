...
<head>
  ...
  <meta name="keywords" content="list of cities in Tunisia" />
  <meta name="description" content="list of cities in Tunisia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Tunisia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Tunisia</strong></div>
  </a>
  <h1>
    List of populous places in Tunisia
  </h1>
  <h2>
    Text list of all Tunisia cities and towns
  </h2>
  <p>
    Here is the full list of Tunisia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Tunisia
  </h2>
  <pre>
    <?php
    $file = "list_cities_tunisia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Tunisia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_tunisia.txt">list_cities_tunisia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Tunisia cities, text list of Tunisia towns, text list of Tunisia places txt, list of cities in Tunisia, list of cities in Tunisia, list of cities in the Tunisia,
      list of big cities in Tunisia, list of largest cities in Tunisia, list of biggest cities in Tunisia, list of towns in Tunisia, list of capital cities in Tunisia,
      names of cities in Tunisia, list of major cities in Tunisia, list of most populated cities in Tunisia, Tunisia states and cities list
      list of most populated cities in Tunisia, database cities Tunisia, database cities Tunisia, database cities Tunisia, cities of the Tunisia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
