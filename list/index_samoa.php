...
<head>
  ...
  <meta name="keywords" content="list of cities in Samoa" />
  <meta name="description" content="list of cities in Samoa, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Samoa text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Samoa</strong></div>
  </a>
  <h1>
    List of populous places in Samoa
  </h1>
  <h2>
    Text list of all Samoa cities and towns
  </h2>
  <p>
    Here is the full list of Samoa cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Samoa
  </h2>
  <pre>
    <?php
    $file = "list_cities_samoa.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Samoa : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_samoa.txt">list_cities_samoa.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Samoa cities, text list of Samoa towns, text list of Samoa places txt, list of cities in Samoa, list of cities in Samoa, list of cities in the Samoa,
      list of big cities in Samoa, list of largest cities in Samoa, list of biggest cities in Samoa, list of towns in Samoa, list of capital cities in Samoa,
      names of cities in Samoa, list of major cities in Samoa, list of most populated cities in Samoa, Samoa states and cities list
      list of most populated cities in Samoa, database cities Samoa, database cities Samoa, database cities Samoa, cities of the Samoa
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
