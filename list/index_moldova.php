...
<head>
  ...
  <meta name="keywords" content="list of cities in Moldova" />
  <meta name="description" content="list of cities in Moldova, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Moldova text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Moldova</strong></div>
  </a>
  <h1>
    List of populous places in Moldova
  </h1>
  <h2>
    Text list of all Moldova cities and towns
  </h2>
  <p>
    Here is the full list of Moldova cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Moldova
  </h2>
  <pre>
    <?php
    $file = "list_cities_moldova.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Moldova : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_moldova.txt">list_cities_moldova.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Moldova cities, text list of Moldova towns, text list of Moldova places txt, list of cities in Moldova, list of cities in Moldova, list of cities in the Moldova,
      list of big cities in Moldova, list of largest cities in Moldova, list of biggest cities in Moldova, list of towns in Moldova, list of capital cities in Moldova,
      names of cities in Moldova, list of major cities in Moldova, list of most populated cities in Moldova, Moldova states and cities list
      list of most populated cities in Moldova, database cities Moldova, database cities Moldova, database cities Moldova, cities of the Moldova
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
