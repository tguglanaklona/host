...
<head>
  ...
  <meta name="keywords" content="list of cities in Croatia" />
  <meta name="description" content="list of cities in Croatia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Croatia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Croatia</strong></div>
  </a>
  <h1>
    List of populous places in Croatia
  </h1>
  <h2>
    Text list of all Croatia cities and towns
  </h2>
  <p>
    Here is the full list of Croatia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Croatia
  </h2>
  <pre>
    <?php
    $file = "list_cities_croatia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Croatia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_croatia.txt">list_cities_croatia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Croatia cities, text list of Croatia towns, text list of Croatia places txt, list of cities in Croatia, list of cities in Croatia, list of cities in the Croatia,
      list of big cities in Croatia, list of largest cities in Croatia, list of biggest cities in Croatia, list of towns in Croatia, list of capital cities in Croatia,
      names of cities in Croatia, list of major cities in Croatia, list of most populated cities in Croatia, Croatia states and cities list
      list of most populated cities in Croatia, database cities Croatia, database cities Croatia, database cities Croatia, cities of the Croatia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
