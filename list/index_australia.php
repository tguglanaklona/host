...
<head>
  ...
  <meta name="keywords" content="list of cities in Australia" />
  <meta name="description" content="list of cities in Australia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Australia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Australia</strong></div>
  </a>
  <h1>
    List of populous places in Australia
  </h1>
  <h2>
    Text list of all Australia cities and towns
  </h2>
  <p>
    Here is the full list of Australia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Australia
  </h2>
  <pre>
    <?php
    $file = "list_cities_australia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Australia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_australia.txt">list_cities_australia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Australia cities, text list of Australia towns, text list of Australia places txt, list of cities in Australia, list of cities in Australia, list of cities in the Australia,
      list of big cities in Australia, list of largest cities in Australia, list of biggest cities in Australia, list of towns in Australia, list of capital cities in Australia,
      names of cities in Australia, list of major cities in Australia, list of most populated cities in Australia, Australia states and cities list
      list of most populated cities in Australia, database cities Australia, database cities Australia, database cities Australia, cities of the Australia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
