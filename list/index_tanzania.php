...
<head>
  ...
  <meta name="keywords" content="list of cities in Tanzania" />
  <meta name="description" content="list of cities in Tanzania, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Tanzania text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Tanzania</strong></div>
  </a>
  <h1>
    List of populous places in Tanzania
  </h1>
  <h2>
    Text list of all Tanzania cities and towns
  </h2>
  <p>
    Here is the full list of Tanzania cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Tanzania
  </h2>
  <pre>
    <?php
    $file = "list_cities_tanzania.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Tanzania : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_tanzania.txt">list_cities_tanzania.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Tanzania cities, text list of Tanzania towns, text list of Tanzania places txt, list of cities in Tanzania, list of cities in Tanzania, list of cities in the Tanzania,
      list of big cities in Tanzania, list of largest cities in Tanzania, list of biggest cities in Tanzania, list of towns in Tanzania, list of capital cities in Tanzania,
      names of cities in Tanzania, list of major cities in Tanzania, list of most populated cities in Tanzania, Tanzania states and cities list
      list of most populated cities in Tanzania, database cities Tanzania, database cities Tanzania, database cities Tanzania, cities of the Tanzania
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
