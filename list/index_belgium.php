...
<head>
  ...
  <meta name="keywords" content="list of cities in Belgium" />
  <meta name="description" content="list of cities in Belgium, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Belgium text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Belgium</strong></div>
  </a>
  <h1>
    List of populous places in Belgium
  </h1>
  <h2>
    Text list of all Belgium cities and towns
  </h2>
  <p>
    Here is the full list of Belgium cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Belgium
  </h2>
  <pre>
    <?php
    $file = "list_cities_belgium.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Belgium : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_belgium.txt">list_cities_belgium.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Belgium cities, text list of Belgium towns, text list of Belgium places txt, list of cities in Belgium, list of cities in Belgium, list of cities in the Belgium,
      list of big cities in Belgium, list of largest cities in Belgium, list of biggest cities in Belgium, list of towns in Belgium, list of capital cities in Belgium,
      names of cities in Belgium, list of major cities in Belgium, list of most populated cities in Belgium, Belgium states and cities list
      list of most populated cities in Belgium, database cities Belgium, database cities Belgium, database cities Belgium, cities of the Belgium
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
