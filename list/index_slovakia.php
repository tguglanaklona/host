...
<head>
  ...
  <meta name="keywords" content="list of cities in Slovakia" />
  <meta name="description" content="list of cities in Slovakia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Slovakia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Slovakia</strong></div>
  </a>
  <h1>
    List of populous places in Slovakia
  </h1>
  <h2>
    Text list of all Slovakia cities and towns
  </h2>
  <p>
    Here is the full list of Slovakia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Slovakia
  </h2>
  <pre>
    <?php
    $file = "list_cities_slovakia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Slovakia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_slovakia.txt">list_cities_slovakia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Slovakia cities, text list of Slovakia towns, text list of Slovakia places txt, list of cities in Slovakia, list of cities in Slovakia, list of cities in the Slovakia,
      list of big cities in Slovakia, list of largest cities in Slovakia, list of biggest cities in Slovakia, list of towns in Slovakia, list of capital cities in Slovakia,
      names of cities in Slovakia, list of major cities in Slovakia, list of most populated cities in Slovakia, Slovakia states and cities list
      list of most populated cities in Slovakia, database cities Slovakia, database cities Slovakia, database cities Slovakia, cities of the Slovakia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
