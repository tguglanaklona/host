...
<head>
  ...
  <meta name="keywords" content="list of cities in Malaysia" />
  <meta name="description" content="list of cities in Malaysia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Malaysia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Malaysia</strong></div>
  </a>
  <h1>
    List of populous places in Malaysia
  </h1>
  <h2>
    Text list of all Malaysia cities and towns
  </h2>
  <p>
    Here is the full list of Malaysia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Malaysia
  </h2>
  <pre>
    <?php
    $file = "list_cities_malaysia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Malaysia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_malaysia.txt">list_cities_malaysia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Malaysia cities, text list of Malaysia towns, text list of Malaysia places txt, list of cities in Malaysia, list of cities in Malaysia, list of cities in the Malaysia,
      list of big cities in Malaysia, list of largest cities in Malaysia, list of biggest cities in Malaysia, list of towns in Malaysia, list of capital cities in Malaysia,
      names of cities in Malaysia, list of major cities in Malaysia, list of most populated cities in Malaysia, Malaysia states and cities list
      list of most populated cities in Malaysia, database cities Malaysia, database cities Malaysia, database cities Malaysia, cities of the Malaysia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
