...
<head>
  ...
  <meta name="keywords" content="list of cities in Afghanistan" />
  <meta name="description" content="list of cities in Afghanistan, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Afghanistan text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Afghanistan</strong></div>
  </a>
  <h1>
    List of populous places in Afghanistan
  </h1>
  <h2>
    Text list of all Afghanistan cities and towns
  </h2>
  <p>
    Here is the full list of Afghanistan cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Afghanistan
  </h2>
  <pre>
    <?php
    $file = "list_cities_afghanistan.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Afghanistan : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_afghanistan.txt">list_cities_afghanistan.txt</a>
  </p>
  <ul>
    <li>
