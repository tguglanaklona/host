...
<head>
  ...
  <meta name="keywords" content="list of cities in North Korea" />
  <meta name="description" content="list of cities in North Korea, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="North Korea text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>North Korea</strong></div>
  </a>
  <h1>
    List of populous places in North Korea
  </h1>
  <h2>
    Text list of all North Korea cities and towns
  </h2>
  <p>
    Here is the full list of North Korea cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in North Korea
  </h2>
  <pre>
    <?php
    $file = "list_cities_northkorea.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    North Korea : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_northkorea.txt">list_cities_northkorea.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of North Korea cities, text list of North Korea towns, text list of North Korea places txt, list of cities in North Korea, list of cities in North Korea, list of cities in the North Korea,
      list of big cities in North Korea, list of largest cities in North Korea, list of biggest cities in North Korea, list of towns in North Korea, list of capital cities in North Korea,
      names of cities in North Korea, list of major cities in North Korea, list of most populated cities in North Korea, North Korea states and cities list
      list of most populated cities in North Korea, database cities North Korea, database cities North Korea, database cities North Korea, cities of the North Korea
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
