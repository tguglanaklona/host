...
<head>
  ...
  <meta name="keywords" content="list of cities in Benin" />
  <meta name="description" content="list of cities in Benin, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Benin text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Benin</strong></div>
  </a>
  <h1>
    List of populous places in Benin
  </h1>
  <h2>
    Text list of all Benin cities and towns
  </h2>
  <p>
    Here is the full list of Benin cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Benin
  </h2>
  <pre>
    <?php
    $file = "list_cities_benin.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Benin : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_benin.txt">list_cities_benin.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Benin cities, text list of Benin towns, text list of Benin places txt, list of cities in Benin, list of cities in Benin, list of cities in the Benin,
      list of big cities in Benin, list of largest cities in Benin, list of biggest cities in Benin, list of towns in Benin, list of capital cities in Benin,
      names of cities in Benin, list of major cities in Benin, list of most populated cities in Benin, Benin states and cities list
      list of most populated cities in Benin, database cities Benin, database cities Benin, database cities Benin, cities of the Benin
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
