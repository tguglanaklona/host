...
<head>
  ...
  <meta name="keywords" content="list of cities in Mexico" />
  <meta name="description" content="list of cities in Mexico, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Mexico text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Mexico</strong></div>
  </a>
  <h1>
    List of populous places in Mexico
  </h1>
  <h2>
    Text list of all Mexico cities and towns
  </h2>
  <p>
    Here is the full list of Mexico cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Mexico
  </h2>
  <pre>
    <?php
    $file = "list_cities_mexico.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Mexico : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_mexico.txt">list_cities_mexico.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Mexico cities, text list of Mexico towns, text list of Mexico places txt, list of cities in Mexico, list of cities in Mexico, list of cities in the Mexico,
      list of big cities in Mexico, list of largest cities in Mexico, list of biggest cities in Mexico, list of towns in Mexico, list of capital cities in Mexico,
      names of cities in Mexico, list of major cities in Mexico, list of most populated cities in Mexico, Mexico states and cities list
      list of most populated cities in Mexico, database cities Mexico, database cities Mexico, database cities Mexico, cities of the Mexico
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
