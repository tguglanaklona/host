...
<head>
  ...
  <meta name="keywords" content="list of cities in Lithuania" />
  <meta name="description" content="list of cities in Lithuania, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Lithuania text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Lithuania</strong></div>
  </a>
  <h1>
    List of populous places in Lithuania
  </h1>
  <h2>
    Text list of all Lithuania cities and towns
  </h2>
  <p>
    Here is the full list of Lithuania cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Lithuania
  </h2>
  <pre>
    <?php
    $file = "list_cities_lithuania.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Lithuania : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_lithuania.txt">list_cities_lithuania.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Lithuania cities, text list of Lithuania towns, text list of Lithuania places txt, list of cities in Lithuania, list of cities in Lithuania, list of cities in the Lithuania,
      list of big cities in Lithuania, list of largest cities in Lithuania, list of biggest cities in Lithuania, list of towns in Lithuania, list of capital cities in Lithuania,
      names of cities in Lithuania, list of major cities in Lithuania, list of most populated cities in Lithuania, Lithuania states and cities list
      list of most populated cities in Lithuania, database cities Lithuania, database cities Lithuania, database cities Lithuania, cities of the Lithuania
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
