...
<head>
  ...
  <meta name="keywords" content="list of cities in Zimbabwe" />
  <meta name="description" content="list of cities in Zimbabwe, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Zimbabwe text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Zimbabwe</strong></div>
  </a>
  <h1>
    List of populous places in Zimbabwe
  </h1>
  <h2>
    Text list of all Zimbabwe cities and towns
  </h2>
  <p>
    Here is the full list of Zimbabwe cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Zimbabwe
  </h2>
  <pre>
    <?php
    $file = "list_cities_zimbabwe.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Zimbabwe : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_zimbabwe.txt">list_cities_zimbabwe.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Zimbabwe cities, text list of Zimbabwe towns, text list of Zimbabwe places txt, list of cities in Zimbabwe, list of cities in Zimbabwe, list of cities in the Zimbabwe,
      list of big cities in Zimbabwe, list of largest cities in Zimbabwe, list of biggest cities in Zimbabwe, list of towns in Zimbabwe, list of capital cities in Zimbabwe,
      names of cities in Zimbabwe, list of major cities in Zimbabwe, list of most populated cities in Zimbabwe, Zimbabwe states and cities list
      list of most populated cities in Zimbabwe, database cities Zimbabwe, database cities Zimbabwe, database cities Zimbabwe, cities of the Zimbabwe
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
