...
<head>
  ...
  <meta name="keywords" content="list of cities in Iran" />
  <meta name="description" content="list of cities in Iran, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Iran text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Iran</strong></div>
  </a>
  <h1>
    List of populous places in Iran
  </h1>
  <h2>
    Text list of all Iran cities and towns
  </h2>
  <p>
    Here is the full list of Iran cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Iran
  </h2>
  <pre>
    <?php
    $file = "list_cities_iran.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Iran : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_iran.txt">list_cities_iran.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Iran cities, text list of Iran towns, text list of Iran places txt, list of cities in Iran, list of cities in Iran, list of cities in the Iran,
      list of big cities in Iran, list of largest cities in Iran, list of biggest cities in Iran, list of towns in Iran, list of capital cities in Iran,
      names of cities in Iran, list of major cities in Iran, list of most populated cities in Iran, Iran states and cities list
      list of most populated cities in Iran, database cities Iran, database cities Iran, database cities Iran, cities of the Iran
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
