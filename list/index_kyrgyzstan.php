...
<head>
  ...
  <meta name="keywords" content="list of cities in Kyrgyzstan" />
  <meta name="description" content="list of cities in Kyrgyzstan, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Kyrgyzstan text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Kyrgyzstan</strong></div>
  </a>
  <h1>
    List of populous places in Kyrgyzstan
  </h1>
  <h2>
    Text list of all Kyrgyzstan cities and towns
  </h2>
  <p>
    Here is the full list of Kyrgyzstan cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Kyrgyzstan
  </h2>
  <pre>
    <?php
    $file = "list_cities_kyrgyzstan.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Kyrgyzstan : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_kyrgyzstan.txt">list_cities_kyrgyzstan.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Kyrgyzstan cities, text list of Kyrgyzstan towns, text list of Kyrgyzstan places txt, list of cities in Kyrgyzstan, list of cities in Kyrgyzstan, list of cities in the Kyrgyzstan,
      list of big cities in Kyrgyzstan, list of largest cities in Kyrgyzstan, list of biggest cities in Kyrgyzstan, list of towns in Kyrgyzstan, list of capital cities in Kyrgyzstan,
      names of cities in Kyrgyzstan, list of major cities in Kyrgyzstan, list of most populated cities in Kyrgyzstan, Kyrgyzstan states and cities list
      list of most populated cities in Kyrgyzstan, database cities Kyrgyzstan, database cities Kyrgyzstan, database cities Kyrgyzstan, cities of the Kyrgyzstan
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
