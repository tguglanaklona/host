...
<head>
  ...
  <meta name="keywords" content="list of cities in Sudan" />
  <meta name="description" content="list of cities in Sudan, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Sudan text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Sudan</strong></div>
  </a>
  <h1>
    List of populous places in Sudan
  </h1>
  <h2>
    Text list of all Sudan cities and towns
  </h2>
  <p>
    Here is the full list of Sudan cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Sudan
  </h2>
  <pre>
    <?php
    $file = "list_cities_sudan.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Sudan : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_sudan.txt">list_cities_sudan.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Sudan cities, text list of Sudan towns, text list of Sudan places txt, list of cities in Sudan, list of cities in Sudan, list of cities in the Sudan,
      list of big cities in Sudan, list of largest cities in Sudan, list of biggest cities in Sudan, list of towns in Sudan, list of capital cities in Sudan,
      names of cities in Sudan, list of major cities in Sudan, list of most populated cities in Sudan, Sudan states and cities list
      list of most populated cities in Sudan, database cities Sudan, database cities Sudan, database cities Sudan, cities of the Sudan
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
