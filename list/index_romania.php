...
<head>
  ...
  <meta name="keywords" content="list of cities in Romania" />
  <meta name="description" content="list of cities in Romania, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Romania text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Romania</strong></div>
  </a>
  <h1>
    List of populous places in Romania
  </h1>
  <h2>
    Text list of all Romania cities and towns
  </h2>
  <p>
    Here is the full list of Romania cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Romania
  </h2>
  <pre>
    <?php
    $file = "list_cities_romania.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Romania : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_romania.txt">list_cities_romania.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Romania cities, text list of Romania towns, text list of Romania places txt, list of cities in Romania, list of cities in Romania, list of cities in the Romania,
      list of big cities in Romania, list of largest cities in Romania, list of biggest cities in Romania, list of towns in Romania, list of capital cities in Romania,
      names of cities in Romania, list of major cities in Romania, list of most populated cities in Romania, Romania states and cities list
      list of most populated cities in Romania, database cities Romania, database cities Romania, database cities Romania, cities of the Romania
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
