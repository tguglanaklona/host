...
<head>
  ...
  <meta name="keywords" content="list of cities in Hong Kong" />
  <meta name="description" content="list of cities in Hong Kong, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Hong Kong text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Hong Kong</strong></div>
  </a>
  <h1>
    List of populous places in Hong Kong
  </h1>
  <h2>
    Text list of all Hong Kong cities and towns
  </h2>
  <p>
    Here is the full list of Hong Kong cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Hong Kong
  </h2>
  <pre>
    <?php
    $file = "list_cities_hongkong.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Hong Kong : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_hongkong.txt">list_cities_hongkong.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Hong Kong cities, text list of Hong Kong towns, text list of Hong Kong places txt, list of cities in Hong Kong, list of cities in Hong Kong, list of cities in the Hong Kong,
      list of big cities in Hong Kong, list of largest cities in Hong Kong, list of biggest cities in Hong Kong, list of towns in Hong Kong, list of capital cities in Hong Kong,
      names of cities in Hong Kong, list of major cities in Hong Kong, list of most populated cities in Hong Kong, Hong Kong states and cities list
      list of most populated cities in Hong Kong, database cities Hong Kong, database cities Hong Kong, database cities Hong Kong, cities of the Hong Kong
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
