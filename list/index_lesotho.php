...
<head>
  ...
  <meta name="keywords" content="list of cities in Lesotho" />
  <meta name="description" content="list of cities in Lesotho, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Lesotho text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Lesotho</strong></div>
  </a>
  <h1>
    List of populous places in Lesotho
  </h1>
  <h2>
    Text list of all Lesotho cities and towns
  </h2>
  <p>
    Here is the full list of Lesotho cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Lesotho
  </h2>
  <pre>
    <?php
    $file = "list_cities_lesotho.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Lesotho : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_lesotho.txt">list_cities_lesotho.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Lesotho cities, text list of Lesotho towns, text list of Lesotho places txt, list of cities in Lesotho, list of cities in Lesotho, list of cities in the Lesotho,
      list of big cities in Lesotho, list of largest cities in Lesotho, list of biggest cities in Lesotho, list of towns in Lesotho, list of capital cities in Lesotho,
      names of cities in Lesotho, list of major cities in Lesotho, list of most populated cities in Lesotho, Lesotho states and cities list
      list of most populated cities in Lesotho, database cities Lesotho, database cities Lesotho, database cities Lesotho, cities of the Lesotho
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
