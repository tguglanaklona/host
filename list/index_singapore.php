...
<head>
  ...
  <meta name="keywords" content="list of cities in Singapore" />
  <meta name="description" content="list of cities in Singapore, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Singapore text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Singapore</strong></div>
  </a>
  <h1>
    List of populous places in Singapore
  </h1>
  <h2>
    Text list of all Singapore cities and towns
  </h2>
  <p>
    Here is the full list of Singapore cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Singapore
  </h2>
  <pre>
    <?php
    $file = "list_cities_singapore.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Singapore : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_singapore.txt">list_cities_singapore.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Singapore cities, text list of Singapore towns, text list of Singapore places txt, list of cities in Singapore, list of cities in Singapore, list of cities in the Singapore,
      list of big cities in Singapore, list of largest cities in Singapore, list of biggest cities in Singapore, list of towns in Singapore, list of capital cities in Singapore,
      names of cities in Singapore, list of major cities in Singapore, list of most populated cities in Singapore, Singapore states and cities list
      list of most populated cities in Singapore, database cities Singapore, database cities Singapore, database cities Singapore, cities of the Singapore
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
