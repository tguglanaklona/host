...
<head>
  ...
  <meta name="keywords" content="list of cities in Denmark" />
  <meta name="description" content="list of cities in Denmark, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Denmark text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Denmark</strong></div>
  </a>
  <h1>
    List of populous places in Denmark
  </h1>
  <h2>
    Text list of all Denmark cities and towns
  </h2>
  <p>
    Here is the full list of Denmark cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Denmark
  </h2>
  <pre>
    <?php
    $file = "list_cities_denmark.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Denmark : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_denmark.txt">list_cities_denmark.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Denmark cities, text list of Denmark towns, text list of Denmark places txt, list of cities in Denmark, list of cities in Denmark, list of cities in the Denmark,
      list of big cities in Denmark, list of largest cities in Denmark, list of biggest cities in Denmark, list of towns in Denmark, list of capital cities in Denmark,
      names of cities in Denmark, list of major cities in Denmark, list of most populated cities in Denmark, Denmark states and cities list
      list of most populated cities in Denmark, database cities Denmark, database cities Denmark, database cities Denmark, cities of the Denmark
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
