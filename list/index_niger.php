...
<head>
  ...
  <meta name="keywords" content="list of cities in Niger" />
  <meta name="description" content="list of cities in Niger, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Niger text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Niger</strong></div>
  </a>
  <h1>
    List of populous places in Niger
  </h1>
  <h2>
    Text list of all Niger cities and towns
  </h2>
  <p>
    Here is the full list of Niger cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Niger
  </h2>
  <pre>
    <?php
    $file = "list_cities_niger.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Niger : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_niger.txt">list_cities_niger.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Niger cities, text list of Niger towns, text list of Niger places txt, list of cities in Niger, list of cities in Niger, list of cities in the Niger,
      list of big cities in Niger, list of largest cities in Niger, list of biggest cities in Niger, list of towns in Niger, list of capital cities in Niger,
      names of cities in Niger, list of major cities in Niger, list of most populated cities in Niger, Niger states and cities list
      list of most populated cities in Niger, database cities Niger, database cities Niger, database cities Niger, cities of the Niger
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
