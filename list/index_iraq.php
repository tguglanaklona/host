...
<head>
  ...
  <meta name="keywords" content="list of cities in Iraq" />
  <meta name="description" content="list of cities in Iraq, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Iraq text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Iraq</strong></div>
  </a>
  <h1>
    List of populous places in Iraq
  </h1>
  <h2>
    Text list of all Iraq cities and towns
  </h2>
  <p>
    Here is the full list of Iraq cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Iraq
  </h2>
  <pre>
    <?php
    $file = "list_cities_iraq.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Iraq : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_iraq.txt">list_cities_iraq.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Iraq cities, text list of Iraq towns, text list of Iraq places txt, list of cities in Iraq, list of cities in Iraq, list of cities in the Iraq,
      list of big cities in Iraq, list of largest cities in Iraq, list of biggest cities in Iraq, list of towns in Iraq, list of capital cities in Iraq,
      names of cities in Iraq, list of major cities in Iraq, list of most populated cities in Iraq, Iraq states and cities list
      list of most populated cities in Iraq, database cities Iraq, database cities Iraq, database cities Iraq, cities of the Iraq
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
