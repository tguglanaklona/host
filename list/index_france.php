...
<head>
  ...
  <meta name="keywords" content="list of cities in France" />
  <meta name="description" content="list of cities in France, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="France text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>France</strong></div>
  </a>
  <h1>
    List of populous places in France
  </h1>
  <h2>
    Text list of all France cities and towns
  </h2>
  <p>
    Here is the full list of France cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in France
  </h2>
  <pre>
    <?php
    $file = "list_cities_france.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    France : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_france.txt">list_cities_france.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of France cities, text list of France towns, text list of France places txt, list of cities in France, list of cities in France, list of cities in the France,
      list of big cities in France, list of largest cities in France, list of biggest cities in France, list of towns in France, list of capital cities in France,
      names of cities in France, list of major cities in France, list of most populated cities in France, France states and cities list
      list of most populated cities in France, database cities France, database cities France, database cities France, cities of the France
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
