...
<head>
  ...
  <meta name="keywords" content="list of cities in Barbados" />
  <meta name="description" content="list of cities in Barbados, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Barbados text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Barbados</strong></div>
  </a>
  <h1>
    List of populous places in Barbados
  </h1>
  <h2>
    Text list of all Barbados cities and towns
  </h2>
  <p>
    Here is the full list of Barbados cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Barbados
  </h2>
  <pre>
    <?php
    $file = "list_cities_barbados.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Barbados : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_barbados.txt">list_cities_barbados.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Barbados cities, text list of Barbados towns, text list of Barbados places txt, list of cities in Barbados, list of cities in Barbados, list of cities in the Barbados,
      list of big cities in Barbados, list of largest cities in Barbados, list of biggest cities in Barbados, list of towns in Barbados, list of capital cities in Barbados,
      names of cities in Barbados, list of major cities in Barbados, list of most populated cities in Barbados, Barbados states and cities list
      list of most populated cities in Barbados, database cities Barbados, database cities Barbados, database cities Barbados, cities of the Barbados
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
