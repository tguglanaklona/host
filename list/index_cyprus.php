...
<head>
  ...
  <meta name="keywords" content="list of cities in Cyprus" />
  <meta name="description" content="list of cities in Cyprus, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Cyprus text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Cyprus</strong></div>
  </a>
  <h1>
    List of populous places in Cyprus
  </h1>
  <h2>
    Text list of all Cyprus cities and towns
  </h2>
  <p>
    Here is the full list of Cyprus cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Cyprus
  </h2>
  <pre>
    <?php
    $file = "list_cities_cyprus.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Cyprus : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_cyprus.txt">list_cities_cyprus.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Cyprus cities, text list of Cyprus towns, text list of Cyprus places txt, list of cities in Cyprus, list of cities in Cyprus, list of cities in the Cyprus,
      list of big cities in Cyprus, list of largest cities in Cyprus, list of biggest cities in Cyprus, list of towns in Cyprus, list of capital cities in Cyprus,
      names of cities in Cyprus, list of major cities in Cyprus, list of most populated cities in Cyprus, Cyprus states and cities list
      list of most populated cities in Cyprus, database cities Cyprus, database cities Cyprus, database cities Cyprus, cities of the Cyprus
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
