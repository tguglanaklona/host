...
<head>
  ...
  <meta name="keywords" content="list of cities in Jersey" />
  <meta name="description" content="list of cities in Jersey, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Jersey text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Jersey</strong></div>
  </a>
  <h1>
    List of populous places in Jersey
  </h1>
  <h2>
    Text list of all Jersey cities and towns
  </h2>
  <p>
    Here is the full list of Jersey cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Jersey
  </h2>
  <pre>
    <?php
    $file = "list_cities_jersey_replace.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Jersey : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_jersey_replace.txt">list_cities_jersey_replace.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Jersey cities, text list of Jersey towns, text list of Jersey places txt, list of cities in Jersey, list of cities in Jersey, list of cities in the Jersey,
      list of big cities in Jersey, list of largest cities in Jersey, list of biggest cities in Jersey, list of towns in Jersey, list of capital cities in Jersey,
      names of cities in Jersey, list of major cities in Jersey, list of most populated cities in Jersey, Jersey states and cities list
      list of most populated cities in Jersey, database cities Jersey, database cities Jersey, database cities Jersey, cities of the Jersey
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
