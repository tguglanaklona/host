...
<head>
  ...
  <meta name="keywords" content="list of cities in Liberia" />
  <meta name="description" content="list of cities in Liberia, text format database" />
  <meta name="document-state" content="Dynamic" />
  <meta name="generator" content="Geography Collector">
  <meta name="title" content="Liberia text list of cities" />
...
<!-- End Google Tag Manager -->
  ...
  <a href="http://www.geographycollector.com" class="brand">
    ...
    <div class="brand-text"><strong>Geography</strong> collector : list of cities in <strong>Liberia</strong></div>
  </a>
  <h1>
    List of populous places in Liberia
  </h1>
  <h2>
    Text list of all Liberia cities and towns
  </h2>
  <p>
    Here is the full list of Liberia cities, towns and cencus-designated places (CDPs) in txt. Data is parsed directly from <a href="http://en.wikipedia.org">Wiki</a> and corrected manually. You can download it in <b>text format</b> (txt) below.
  </p>
  <p>
  ...
  <h2>
    Full list of populated places in Liberia
  </h2>
  <pre>
    <?php
    $file = "list_cities_liberia.txt";
    $contents = file_get_contents($file); 
    echo "\n".$contents;
    ?>
  </pre>
  <h2>
    Liberia : Free downloadable database, text file (txt)
  </h2>
  <p>
    <a href="list_cities_liberia.txt">list_cities_liberia.txt</a>
  </p>
  <ul>
    <li>
    ...
    <li>
      text list of Liberia cities, text list of Liberia towns, text list of Liberia places txt, list of cities in Liberia, list of cities in Liberia, list of cities in the Liberia,
      list of big cities in Liberia, list of largest cities in Liberia, list of biggest cities in Liberia, list of towns in Liberia, list of capital cities in Liberia,
      names of cities in Liberia, list of major cities in Liberia, list of most populated cities in Liberia, Liberia states and cities list
      list of most populated cities in Liberia, database cities Liberia, database cities Liberia, database cities Liberia, cities of the Liberia
    </li>
  </ul>
  <ul> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
  	 <!-- test --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- --> <!-- -->
